...
TRUCK_TYPE_PATTERNS = {
    ...
    "dg": {"contains": "DG", "description": "Contains 'DG' anywhere in truck number"},
    "tank_truck": {
...
equipment_mapping_helpdesk = {
    ...
    "Header PT": {
        "internal_type": ["Fire Effect", "Fire Pump"],
        "search_level": "device",
    },
    ...
    "Safety PLC": {
        "internal_type": ["PLC"],
        "search_level": "device",
        "name_filter": "Safety PLC",
    },
    "Process PLC": {
        "internal_type": ["PLC"],
        "search_level": "device",
        "name_filter": "Process PLC",
    },
    "Header MOVs": {
        "internal_type": ["Tank"],
        "search_level": "sensor",
    ...
    "Primary Radar": {
        "internal_type": ["Tank"],
        "search_level": "sensor",
        "filter_keywords": ["Primary Radar"],
    },
    "Secondary Radars": {
        "internal_type": ["Tank"],
        "search_level": "sensor",
        "filter_keywords": ["RADAR"],
    },
    "VFTs": {
        "internal_type": ["Tank"],
        "search_level": "sensor",
...
def build_date_filter(start_date, end_date):
    ...
    if (
        ...
        and end_date.strip()
        and start_date.lower() != "string"
        and end_date.lower() != "string"
    ):
...
def build_complete_query(
    base_query, start_date=None, end_date=None, location_name=None
):
