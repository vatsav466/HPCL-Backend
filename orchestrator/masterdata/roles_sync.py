...
async def sync_user_roles():
    role_mapping = {
                    ...
                    "Location In-Charge SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                        "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                                "Video Analytics"]}],
                                                    "name": "SOD", "status": True},

                    "Safety Officer SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                        "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                                "Video Analytics"]}],
                                                    "name": "SOD", "status": True},
                    
                    "M&I Officer SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                        "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                                "Video Analytics"]}],
                                                    "name": "SOD", "status": True},


                    "Zonal Safety Officer SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                    "Video Analytics"]}], "name": "SOD",
                                            "status": True},

                    "Zonal M&I Officer SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                    "Video Analytics"]}], "name": "SOD",
                                            "status": True},
                    
                    "Zonal SOD": {"allowed_pages": [{"menu_name": "SOD Terminal",
                                                                "allowed_sub_menus": ["Supply Chain", "Terminal Home",
                                                                                    "Video Analytics"]}], "name": "SOD",
                                            "status": True},
                    ...
                    "Regional Manager LPG": {"allowed_pages": [{"menu_name": "LPG",
                                                              "allowed_sub_menus": ["LPG Operations", "LPG Home",
                                                                                    "LPG Plant",
                                                                                    "Video Analytics"]}],
                                           "name": "SOD", "status": True},
