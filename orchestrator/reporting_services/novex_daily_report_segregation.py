...
async def publish_daily_novex_status_email():
    ...
    await send_notification(
        ...
        bcc_recipients=["shubhra.Narayan@hpcl.in","sachinkwarghane@hpcl.in","purushm@hpcl.in","adityapandey@hpcl.in","arpitaKanak.Bara@hpcl.in" , "shrikantsaini@hpcl.in", "vgupta@hpcl.in" ,"avinashgaurav@hpcl.in",
    ...
    await send_notification(
        ...
        bcc_recipients=["cvmallinath@hpcl.in","ritwik.rath@hpcl.in","is.head@hpcl.in","sachinkwarghane@hpcl.in","purushm@hpcl.in","gkpatel@hpcl.in",
                        "adityapandey@hpcl.in","arpitaKanak.Bara@hpcl.in","shrikantsaini@hpcl.in","vgupta@hpcl.in","avinashgaurav@hpcl.in",
                        "sreedhar.maddipati@algofusiontech.com","venu@algofusiontech.com","moufikali@algofusiontech.com","aditya@algofusiontech.com",
                        "yesu.p@algofusiontech.com","vamsi.c@algofusiontech.com","manohar.v@algofusiontech.com","gayathri.m@algofusiontech.com",
                        "poojitha.gumma@algofusiontech.com","mrudula.m@algofusiontech.com","mohith.p@algofusiontech.com","pawann.k@algofusiontech.com"],
        notification_data=status_data,
    ...
    await send_notification(
        ...
        bcc_recipients=["cvmallinath@hpcl.in","ritwik.rath@hpcl.in","is.head@hpcl.in","sachinkwarghane@hpcl.in","purushm@hpcl.in",
                        "gkpatel@hpcl.in","adityapandey@hpcl.in","shrikantsaini@hpcl.in","arpitaKanak.Bara@hpcl.in", "vgupta@hpcl.in","avinashgaurav@hpcl.in",
                        "sreedhar.maddipati@algofusiontech.com","venu@algofusiontech.com","moufikali@algofusiontech.com","aditya@algofusiontech.com",
                        "yesu.p@algofusiontech.com","vamsi.c@algofusiontech.com","manohar.v@algofusiontech.com","gayathri.m@algofusiontech.com",
                        "poojitha.gumma@algofusiontech.com","mrudula.m@algofusiontech.com","mohith.p@algofusiontech.com","pawann.k@algofusiontech.com"],
        notification_data=status_data,
    ...
    await send_notification(
        ...
        cc_recipients=["sachinkwarghane@hpcl.in","purushm@hpcl.in","adityapandey@hpcl.in","shrikantsaini@hpcl.in","arpitaKanak.Bara@hpcl.in", "vgupta@hpcl.in", "avinashgaurav@hpcl.in"],
