...
async def main(camunda_connector_name):
    ...
    topics = [
        "dryout_indentwise_consumer",
        "dryout_indentwise_consumer1",
        "dryout_indentwise_consumer2",
        "dryout_indentwise_consumer3",
        "dryout_indentwise_consumer4",
        "dryout_indentwise_consumer5",
        "dryout_indentwise_consumer6",
        "dryout_indentwise_consumer7",
        "dryout_indentwise_consumer8",
        "dryout_indentwise_consumer9",
        "dryout_indentwise_consumer10",
        "dryout_indentwise_consumer11",
