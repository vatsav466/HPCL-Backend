...
async def indent_sync_ro_daily_dryout():
    try:
        ...
        ro_data_schema = {
            ...
            "volume": pl.Float64,
            "ullage": pl.Float64,
            "avgsales_7days": pl.String,
            "stock_date": pl.Datetime,
            "status": pl.Int64,
            "daysstatus": pl.Int64,
            "sap_color": pl.String,
            "lastrocdate": pl.Datetime,
            "executed_on": pl.Datetime,
            "executed_by": pl.String,
            "pumpable_stock": pl.Float64,
            "rosapcode": pl.String,
            "product_grp": pl.String,
            "product_sap_color": pl.String,
        }
        ...
        await function(
            query="""DROP TABLE IF EXISTS public.sch_inventory_forecast_dashboard_latest"""
        )
        print("drop query")
