...
unbuffer python /opt/ceg/algo/ordchestrator/alerting/listener/sync_ims_dealer_details.py > /var/log/ceg_sys_logs/sync_ims_dealer_details.log
unbuffer python /opt/ceg/algo/ordchestrator/alerting/listener/sync_auto_dc_requests.py > /var/log/ceg_sys_logs/sync_auto_dc_requests.log