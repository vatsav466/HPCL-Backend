...
async def sync_ims_indent_request():
    try:
        ...
        ro_data_schema = {
            ...
            "PROD_REQD_DT": pl.Datetime,
            "CARRY_INDENT": pl.Int64,
            "DEALER_CODE": pl.String,
            "USER_ID": pl.String,
            "PROD_TYPE": pl.String,
            "SOURCE": pl.String,
            "MOT": pl.String,
            "CANCEL_INDENT": pl.String,
            "USER_CANCEL": pl.String,
            "CANCEL_TIME": pl.String,
            "BATCH_NO": pl.Int64,
            "BATCH_STATUS": pl.String,
            "INDENT_STATUS": pl.String,
            "TRANSFER_STATUS": pl.String,
            "BATCH_FLAG": pl.String,
            "FILLING_NO": pl.Int64,
            "DELIVERY_DATE": pl.Datetime,
            "FILLING_SLIP": pl.String,
            "TRUCK_REGNO": pl.String,
            "CANCEL_REMARKS": pl.String,
            "CARRY_FORWARD_DATE": pl.Datetime,
            "CARRY_LOCN": pl.String,
            "ORG_INDENT": pl.Int64,
            "TRUCK_EXITTIME": pl.Datetime,
            "SMS_TRUCKEXIT": pl.String,
            "MANUAL_REMARKS": pl.String,
            "ROUTED_DATE": pl.Datetime,
            "SENDER_MOBILE": pl.String,
            "VALID_INDENT": pl.String,
            "SEND_TO_JDE_TIME": pl.Datetime,
            "OMC_BATCH_REF_NO": pl.String,
            "INDENT_AMOUNT": pl.Float64,
            "CREDIT_AMOUNT": pl.Float64,
            "BALANCE_AMOUNT": pl.Float64,
            "CREDIT_PROCESS_DATE": pl.Datetime,
            "EMAIL_SENT_TO_RM": pl.String,
            "EMAIL_SENT_TO_RM_DATE": pl.Datetime,
            "INDENT_EXECUTABLE_TIME": pl.Datetime,
            "INDENT_HOLD_RELEASE_TIME": pl.Datetime,
            "SEND_TO_JDE_USER": pl.String,
            "THROUGH_TRANSPORTER": pl.String,
            "GREEN_CHANNEL_INDENT": pl.String,
            "CRM_REF_NO": pl.String,
            "DAY_END_MESS_SENT": pl.String,
            "PROD_GROUP_TYPE": pl.String,
            "SHARED_WITH_MGKM": pl.String,
            "MANUAL_ALLOT_REMARKS": pl.String,
            "PENDING_REASON": pl.String,
