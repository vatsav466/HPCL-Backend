...
def get_industry_data():
    ...
    try:
        ...
        res = res.merge(
            df2[["Code", "RO"]], left_on="code", right_on="Code", how="left"
        )
        # print("res",res.columns)
        ...
        print("fixed")
        print(
            f"After merge: total={len(res)}, matched={res['RO'].notna().sum()}, match_rate={res['RO'].notna().mean()*100:.1f}%"
        )
