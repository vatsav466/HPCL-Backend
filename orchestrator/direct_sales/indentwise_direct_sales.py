...
class IndentDryOutDirectSales:
    ...
    async def get_clause_conditions(self):
        ...
        if urdhva_base.ctx.exists():
            ...
            if sap_id:
                ...
                if resp["data"]:
                    clause_conditions["SALES_AREA"] = await self.flatten_sales_areas(
                        resp["data"]
                    )
            elif rpt.get("zone"):
                zones = "', '".join(rpt["zone"])
        ...
        return [
            {"key": key, "value": value} for key, value in clause_conditions.items()
        ]
    ...
    async def get_indent_raised_direct_sales(self, data):
        ...
        for condition in conditions:
            ...
            if condition_key == "DEALER_CODE":
                ...
                where_clause.append(
                    f"""SUBSTR(ir."DEALER_CODE",3,8) IN ('{dealers}')"""
                )
        ...
        return {"status": "success", "indent_raised_count": 0, "data": []}
    ...
    async def get_indent_on_hold_direct_sales(self, data):
        ...
        return {"status": "success", "indent_on_hold_count": 0, "data": []}
    ...
    async def get_pending_indents_direct_sales(self, data):
        ...
        return {"status": "success", "pending_indent_count": 0, "data": []}
    ...
    async def get_valid_indent_direct_sales(self, data):
        ...
        return {"status": "success", "valid_indent_count": 0, "data": []}
    ...
    async def get_cancelled_indent_direct_sales(self, data):
        ...
        return {"status": "success", "cancelled_indent_count": 0, "data": []}
    ...
    async def get_truck_allocated_direct_sales(self, data):
        ...
        return {"status": "success", "truck_allocated_count": 0, "data": []}
    ...
    async def get_send_to_sap_direct_sales(self, data):
        ...
        return {"status": "success", "indent_send_sap_count": 0, "data": []}
    ...
    async def get_sales_order_placed_direct_sales(self, data):
        ...
        return {"status": "success", "sales_order_placed_count": 0, "data": []}
    ...
    async def get_r2_swipe_direct_sales(self, data):
        ...
        return {"status": "success", "r2_swiped_count": 0, "data": []}
    ...
    async def get_is_invoice_created_direct_sales(self, data):
        ...
        return {"status": "success", "is_invoice_created_count": 0, "data": []}
    ...
    async def get_r3_swiped_direct_sales(self, data):
        ...
        indent_raised_resp = await function(query=ims_query)
        if indent_raised_resp:
            pl.DataFrame(indent_raised_resp)
            return {"status": "success", "r3_swiped_count": 0, "data": []}
        return {"status": "success", "r3_swiped_count": 0, "data": []}
    ...
    async def get_vts_direct_sales(self, data):
        ...
        return {"status": "success", "vts_count": 0, "data": []}
    ...
    async def get_delivery_confirmation_direct_sales(self, data):
        ...
        return {"status": "success", "delivery_confirmation_count": 0, "data": []}
