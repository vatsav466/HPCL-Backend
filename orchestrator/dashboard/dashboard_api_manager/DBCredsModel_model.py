...
class DBCredsModelSchema(UrdhvaPostgresBase):
    ...
    host: Mapped[typing.Optional[str]] = mapped_column(
        "host",
        String,
        index=False,
        nullable=True,
    ...
    port: Mapped[typing.Optional[str]] = mapped_column(
        "port",
        String,
        index=False,
        nullable=True,
    ...
    username: Mapped[typing.Optional[str]] = mapped_column(
        "username",
        String,
        index=False,
        nullable=True,
    ...
    password: Mapped[typing.Optional[str]] = mapped_column(
        "password",
        String,
        index=False,
        nullable=True,
    ...
    service_name: Mapped[typing.Optional[str]] = mapped_column(
        "service_name",
        String,
        index=False,
        nullable=True,
    ...
    sid: Mapped[typing.Optional[str]] = mapped_column(
        "sid",
        String,
        index=False,
        nullable=True,
    ...
    security_token: Mapped[typing.Optional[str]] = mapped_column(
        "security_token",
        String,
        index=False,
        nullable=True,
    ...
    domain: Mapped[typing.Optional[str]] = mapped_column(
        "domain",
        String,
        index=False,
        nullable=True,
    ...
    private_pass: Mapped[typing.Optional[str]] = mapped_column(
        "private_pass",
        String,
        index=False,
        nullable=True,
    ...
    private_key_pass: Mapped[typing.Optional[str]] = mapped_column(
        "private_key_pass",
        String,
        index=False,
        nullable=True,
    ...
    source_path: Mapped[typing.Optional[str]] = mapped_column(
        "source_path",
        String,
        index=False,
        nullable=True,
    ...
    dest_path: Mapped[typing.Optional[str]] = mapped_column(
        "dest_path",
        String,
        index=False,
        nullable=True,
    ...
    file_pattern: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "file_pattern",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    params: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "params",
        JSONB,
        index=False,
        nullable=True,
