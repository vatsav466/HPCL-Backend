...
async def nozzlesales_get_nozzle_sales_by_product(
    data: Nozzlesales_Get_Nozzle_Sales_By_ProductParams,
):
...
async def nozzlesales_get_nozzle_sales_day_comparison(
    data: Nozzlesales_Get_Nozzle_Sales_Day_ComparisonParams,
):
...
async def nozzlesales_get_product_performance(
    data: Nozzlesales_Get_Product_PerformanceParams,
):
...
async def nozzlesales_get_degrading_outlets(
    data: Nozzlesales_Get_Degrading_OutletsParams,
):
...
async def nozzlesales_get_top_degrading_dealers(
    data: Nozzlesales_Get_Top_Degrading_DealersParams,
):
...
async def nozzlesales_get_high_risk_outlets(
    data: Nozzlesales_Get_High_Risk_OutletsParams,
):
...
async def nozzlesales_get_zero_sales_outlets(
    data: Nozzlesales_Get_Zero_Sales_OutletsParams,
):
...
async def nozzlesales_get_outlets_by_degrowth_group(
    data: Nozzlesales_Get_Outlets_By_Degrowth_GroupParams,
):
...
async def nozzlesales_get_power_sales_growth_locations(
    data: Nozzlesales_Get_Power_Sales_Growth_LocationsParams,
):
...
async def nozzlesales_nozzle_sales_analysis(
    data: Nozzlesales_Nozzle_Sales_AnalysisParams,
):
...
async def nozzlesales_nozzle_sales_comparison(
    data: Nozzlesales_Nozzle_Sales_ComparisonParams,
):
