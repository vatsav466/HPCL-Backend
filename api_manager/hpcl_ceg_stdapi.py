...
@router.post('/romasterdata', response_model=RoMasterData, tags=['RoMasterData'])
async def create(inputObj: RoMasterDataCreate):
    return await inputObj.create()


@router.put('/romasterdata', response_model=RoMasterData, tags=['RoMasterData'])
async def update(inputObj: RoMasterData):
    return await inputObj.modify()
...
@router.delete('/romasterdata/{id}', tags=['RoMasterData'])
async def delete(id: str):
    return await RoMasterData.delete(id)