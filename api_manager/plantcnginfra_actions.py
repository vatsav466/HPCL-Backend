...
async def plantcnginfra_get_plant_cng_count_infra(
    data: Plantcnginfra_Get_Plant_Cng_Count_InfraParams,
):
    return await plant_retail_functions.get_plant_cng_count_info(
...
async def plantcnginfra_get_retail_company_cng_infra(
    data: Plantcnginfra_Get_Retail_Company_Cng_InfraParams,
):
    return await plant_retail_functions.get_retail_company_cng_info(
        filters=data.filters,
        cross_filters=data.cross_filters,
        drill_state=data.drill_state,
        limit=data.limit,
...
async def plantcnginfra_get_top_five_cng_infra(
    data: Plantcnginfra_Get_Top_Five_Cng_InfraParams,
):
    return await plant_retail_functions.get_top_five_cng_info(
        filters=data.filters,
        cross_filters=data.cross_filters,
        drill_state=data.drill_state,
        limit=data.limit,
...
async def plantcnginfra_get_distinct_cng_retail_infra(
    data: Plantcnginfra_Get_Distinct_Cng_Retail_InfraParams,
):
    return await plant_retail_functions.get_distinct_cng_retail_info(
...
async def plantcnginfra_get_zone_wise_cng_infra(
    data: Plantcnginfra_Get_Zone_Wise_Cng_InfraParams,
):
    return await plant_retail_functions.get_zone_wise_cng_info(
        filters=data.filters,
        cross_filters=data.cross_filters,
        drill_state=data.drill_state,
        limit=data.limit,
