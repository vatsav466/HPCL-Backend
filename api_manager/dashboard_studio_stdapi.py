...
@router.post(
    "/dashboardgroups", response_model=DashboardGroups, tags=["DashboardGroups"]
)
...
@router.get(
    "/dashboardgroups/{id}", response_model=DashboardGroups, tags=["DashboardGroups"]
)
async def get(id: str):
...
@router.get(
    "/dashboardgroups", response_model=DashboardGroupsGetResp, tags=["DashboardGroups"]
)
async def get_all(
    response: fastapi.Response,
    params=fastapi.Depends(urdhva_base.queryparams.QueryParams),
...
@router.get(
    "/solarpanelwetdrycleaning/{id}",
    response_model=SolarPanelWetDryCleaning,
    tags=["SolarPanelWetDryCleaning"],
)
async def get(id: str):
...
@router.get(
    "/solarpanelwetdrycleaning",
    response_model=SolarPanelWetDryCleaningGetResp,
    tags=["SolarPanelWetDryCleaning"],
)
async def get_all(
    response: fastapi.Response,
...
@router.get(
    "/historicsolarpanelwetdrycleaningcreate/{id}",
    response_model=HistoricSolarPanelWetDryCleaningCreate,
    tags=["HistoricSolarPanelWetDryCleaningCreate"],
)
async def get(id: str):
...
@router.get(
    ...
    response_model=HistoricSolarPanelWetDryCleaningCreateGetResp,
    tags=["HistoricSolarPanelWetDryCleaningCreate"],
)
async def get_all(
    response: fastapi.Response,
    ...
    return await HistoricSolarPanelWetDryCleaningCreate.get_all(
        params, skip_secrets=True
    )


@router.get(
    "/solargenerationsummary/{id}",
    response_model=SolarGenerationSummary,
    tags=["SolarGenerationSummary"],
)
async def get(id: str):
...
@router.get(
    "/solargenerationsummary",
    response_model=SolarGenerationSummaryGetResp,
    tags=["SolarGenerationSummary"],
)
async def get_all(
    response: fastapi.Response,
...
@router.get(
    "/solaroutagesummary/{id}",
    response_model=SolarOutageSummary,
    tags=["SolarOutageSummary"],
)
async def get(id: str):
...
@router.get(
    "/solaroutagesummary",
    response_model=SolarOutageSummaryGetResp,
    tags=["SolarOutageSummary"],
)
async def get_all(
    response: fastapi.Response,
...
@router.get(
    "/solarplantcapacity/{id}",
    response_model=SolarPlantCapacity,
    tags=["SolarPlantCapacity"],
)
async def get(id: str):
...
@router.get(
    "/solarplantcapacity",
    response_model=SolarPlantCapacityGetResp,
    tags=["SolarPlantCapacity"],
)
async def get_all(
    response: fastapi.Response,
