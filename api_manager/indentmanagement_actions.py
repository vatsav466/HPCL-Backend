...
async def indentmanagement_get_indents_by_product_volume(
    data: Indentmanagement_Get_Indents_By_Product_VolumeParams,
):
...
async def indentmanagement_get_pending_vs_executed_indents(
    data: Indentmanagement_Get_Pending_Vs_Executed_IndentsParams,
):
...
async def indentmanagement_get_cancelled_indents(
    data: Indentmanagement_Get_Cancelled_IndentsParams,
):
...
async def indentmanagement_get_dtp_dealers_count(
    data: Indentmanagement_Get_Dtp_Dealers_CountParams,
):
...
async def indentmanagement_get_top_dtp_customers(
    data: Indentmanagement_Get_Top_Dtp_CustomersParams,
):
...
async def indentmanagement_get_dct_indents_by_product_volume(
    data: Indentmanagement_Get_Dct_Indents_By_Product_VolumeParams,
):
...
async def indentmanagement_get_trucks_failed_to_report(
    data: Indentmanagement_Get_Trucks_Failed_To_ReportParams,
):
...
async def indentmanagement_get_tpt_indents_vs_availability(
    data: Indentmanagement_Get_Tpt_Indents_Vs_AvailabilityParams,
):
...
async def indentmanagement_get_indents_details(
    data: Indentmanagement_Get_Indents_DetailsParams,
):
...
async def indentmanagement_get_r3_r1_details(
    data: Indentmanagement_Get_R3_R1_DetailsParams,
):
...
async def indentmanagement_get_indent_details(
    data: Indentmanagement_Get_Indent_DetailsParams,
):
