...
async def naturalgasgvconnections_upload_connection_data(
    ...
    return await natural_gas_data_sync.convert_dpr_file_data(upload_file)


# Action confirm_data_sync
@router.post("/confirm_data_sync", tags=["NaturalGasGVConnections"])
async def naturalgasgvconnections_confirm_data_sync(
    data: Naturalgasgvconnections_Confirm_Data_SyncParams,
):
