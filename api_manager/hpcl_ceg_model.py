...
class RolesSchema(UrdhvaPostgresBase):
    ...
    allowed_pages: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "allowed_pages",
        JSONB,
        index=False,
        nullable=True,
    ...
    bu: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "bu",
        ARRAY(String),
        index=False,
        nullable=True,
...
class UserLoginAuditSchema(UrdhvaPostgresBase):
    ...
    login_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "login_time",
    ...
    logout_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "logout_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    login_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "login_status",
        String,
        index=False,
        nullable=True,
    ...
    failure_reason: Mapped[typing.Optional[str]] = mapped_column(
        "failure_reason",
        String,
        index=False,
        nullable=True,
    ...
    user_agent: Mapped[typing.Optional[str]] = mapped_column(
        "user_agent",
        String,
        index=False,
        nullable=True,
...
class UsersSchema(UrdhvaPostgresBase):
    ...
    password: Mapped[typing.Optional[urdhva_base.types.Secret]] = mapped_column(
        "password",
        String,
        index=False,
        nullable=True,
    ...
    employee_number: Mapped[typing.Optional[str]] = mapped_column(
        "employee_number",
        String,
        index=False,
        nullable=True,
    ...
    bu: Mapped[typing.List[typing.Any]] = mapped_column(
        "bu",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    system_role: Mapped[typing.List[str]] = mapped_column(
        "system_role",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    novex_role: Mapped[typing.List[str]] = mapped_column(
        "novex_role",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    region: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "region",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    state: Mapped[typing.List[str]] = mapped_column(
        "state",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    zone: Mapped[typing.List[str]] = mapped_column(
        "zone",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    sales_area: Mapped[typing.List[str]] = mapped_column(
        "sales_area",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    escalation_level: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "escalation_level",
        String,
        index=False,
        nullable=True,
    ...
    is_ad_user: Mapped[bool] = mapped_column(
        "is_ad_user",
        Boolean,
        index=False,
        nullable=False,
    ...
    manual_user: Mapped[bool] = mapped_column(
        "manual_user",
        Boolean,
        index=False,
        nullable=False,
    ...
    contact_number: Mapped[typing.Optional[str]] = mapped_column(
        "contact_number",
        String,
        index=False,
        nullable=True,
    ...
    mfa: Mapped[typing.Optional[bool]] = mapped_column(
        "mfa",
        Boolean,
        index=False,
        nullable=True,
    ...
    login_user_id: Mapped[str] = mapped_column(
        "login_user_id",
        String,
        index=False,
        nullable=False,
    ...
    file_path: Mapped[typing.Optional[str]] = mapped_column(
        "file_path",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(username, employee_id, name="users_username_employee_id"),
    )
...
class UsersCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    mfa: typing.Optional[bool] = pydantic.Field(
        False,
    )
    login_user_id: str
...
class TasActionLogsSchema(UrdhvaPostgresBase):
    ...
    first_name: Mapped[typing.Optional[str]] = mapped_column(
        "first_name",
        String,
        index=False,
        nullable=True,
    ...
    last_name: Mapped[typing.Optional[str]] = mapped_column(
        "last_name",
        String,
        index=False,
        nullable=True,
    ...
    location_name: Mapped[typing.List[str]] = mapped_column(
        "location_name",
        ARRAY(String),
        index=True,
        nullable=False,
    ...
    state: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "state",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    sales_area: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "sales_area",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    action: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "action",
        String,
        index=False,
        nullable=True,
    ...
    section: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "section",
        String,
        index=False,
        nullable=True,
...
class LocationMasterSchema(UrdhvaPostgresBase):
    ...
    bu_id: Mapped[typing.Optional[str]] = mapped_column(
        "bu_id",
        String,
        index=False,
        nullable=True,
    ...
    ro_id: Mapped[typing.Optional[str]] = mapped_column(
        "ro_id",
        String,
        index=False,
        nullable=True,
    ...
    is_active: Mapped[typing.Optional[bool]] = mapped_column(
        "is_active",
        Boolean,
        index=False,
        nullable=True,
    ...
    activation_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "activation_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    activation_notes: Mapped[typing.Optional[str]] = mapped_column(
        "activation_notes",
        String,
        index=False,
        nullable=True,
    ...
    activated_by: Mapped[typing.Optional[str]] = mapped_column(
        "activated_by",
        String,
        index=False,
        nullable=True,
    ...
    deactivated_by: Mapped[typing.Optional[str]] = mapped_column(
        "deactivated_by",
        String,
        index=False,
        nullable=True,
    ...
    deactivation_notes: Mapped[typing.Optional[str]] = mapped_column(
        "deactivation_notes",
        String,
        index=False,
        nullable=True,
    ...
    health_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "health_status",
        String,
        index=False,
        nullable=True,
    ...
    health_notes: Mapped[typing.Optional[str]] = mapped_column(
        "health_notes",
        String,
        index=False,
        nullable=True,
    ...
    scada_vendor: Mapped[typing.Optional[str]] = mapped_column(
        "scada_vendor",
        String,
        index=False,
        nullable=True,
    ...
    scada_version: Mapped[typing.Optional[str]] = mapped_column(
        "scada_version",
        String,
        index=False,
        nullable=True,
    ...
    scada_conn_status: Mapped[typing.Optional[bool]] = mapped_column(
        "scada_conn_status",
        Boolean,
        index=False,
        nullable=True,
    ...
    scada_conn_notes: Mapped[typing.Optional[str]] = mapped_column(
        "scada_conn_notes",
        String,
        index=False,
        nullable=True,
    ...
    district: Mapped[typing.Optional[str]] = mapped_column(
        "district",
        String,
        index=True,
        nullable=True,
    ...
    region_code: Mapped[typing.Optional[str]] = mapped_column(
        "region_code",
        String,
        index=False,
        nullable=True,
    ...
    state: Mapped[typing.Optional[str]] = mapped_column(
        "state",
        String,
        index=True,
        nullable=True,
    ...
    address: Mapped[typing.Optional[str]] = mapped_column(
        "address",
        String,
        index=False,
        nullable=True,
    ...
    pincode: Mapped[typing.Optional[str]] = mapped_column(
        "pincode",
        String,
        index=False,
        nullable=True,
    ...
    dealer_name: Mapped[typing.Optional[str]] = mapped_column(
        "dealer_name",
        String,
        index=False,
        nullable=True,
    ...
    dealer_phone: Mapped[typing.Optional[str]] = mapped_column(
        "dealer_phone",
        String,
        index=False,
        nullable=True,
    ...
    dealer_email: Mapped[typing.Optional[str]] = mapped_column(
        "dealer_email",
        String,
        index=False,
        nullable=True,
    ...
    local_automation_vendor: Mapped[typing.Optional[str]] = mapped_column(
        "local_automation_vendor",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    latitude: Mapped[typing.Optional[str]] = mapped_column(
        "latitude",
        String,
        index=False,
        nullable=True,
    ...
    longitude: Mapped[typing.Optional[str]] = mapped_column(
        "longitude",
        String,
        index=False,
        nullable=True,
    ...
    sales_area: Mapped[typing.Optional[str]] = mapped_column(
        "sales_area",
        String,
        index=False,
        nullable=True,
    ...
    sales_area_code: Mapped[typing.Optional[str]] = mapped_column(
        "sales_area_code",
        String,
        index=False,
        nullable=True,
    ...
    terminal_plant_id: Mapped[typing.Optional[str]] = mapped_column(
        "terminal_plant_id",
        String,
        index=False,
        nullable=True,
    ...
    terminal_plant_name: Mapped[typing.Optional[str]] = mapped_column(
        "terminal_plant_name",
        String,
        index=False,
        nullable=True,
    ...
    category: Mapped[typing.Optional[str]] = mapped_column(
        "category",
        String,
        index=False,
        nullable=True,
    ...
    distributor_code: Mapped[typing.Optional[str]] = mapped_column(
        "distributor_code",
        String,
        index=False,
        nullable=True,
    ...
    distributor_name: Mapped[typing.Optional[str]] = mapped_column(
        "distributor_name",
        String,
        index=False,
        nullable=True,
    ...
    round_trip_distance: Mapped[typing.Optional[int]] = mapped_column(
        "round_trip_distance",
        Integer,
        index=False,
        nullable=True,
    ...
    location_onboard: Mapped[typing.Optional[bool]] = mapped_column(
        "location_onboard",
        Boolean,
        index=False,
        nullable=True,
...
class LocationMasterCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    scada_conn_status: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    location_onboard: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class Locationmaster_Get_Location_MetadataParams(pydantic.BaseModel):
    bu: typing.List[str]
    metadata_filters: typing.Optional[dict] = pydantic.Field(
...
class RoleMasterSchema(UrdhvaPostgresBase):
    ...
    user_name: Mapped[typing.Optional[str]] = mapped_column(
        "user_name",
        String,
        index=False,
        nullable=True,
    ...
    novex_role: Mapped[str] = mapped_column(
        "novex_role",
        String,
        index=True,
        nullable=False,
...
class ROAssetMasterSchema(UrdhvaPostgresBase):
    ...
    mpd_id: Mapped[int] = mapped_column(
        "mpd_id",
        Integer,
        index=False,
        nullable=False,
    ...
    global_nozzle_id: Mapped[int] = mapped_column(
        "global_nozzle_id",
        Integer,
        index=False,
        nullable=False,
...
class TASAssetMasterSchema(UrdhvaPostgresBase):
    ...
    device_tag: Mapped[str] = mapped_column(
        "device_tag",
        String,
        index=False,
        nullable=False,
...
class Alert_HistoryCreate(pydantic.BaseModel):
    ...
    atr_uploaded: typing.Optional[bool] = pydantic.Field(
        False,
    )
    maintenance_exception: typing.Optional[bool] = pydantic.Field(
        False,
    )
    revocation: typing.Optional[bool] = pydantic.Field(
        False,
    )
    no_exception: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_approved: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_exc_approval_time_exp: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_raised: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_cancelled: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_allocated: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_sent_to_sap: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_order_placed: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_created: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_r1_swipe: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_r2_swipe: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_r3_swipe: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_delivered: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_tripped: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_justify: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_vts: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_blocked: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_unblocked: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_interrupt: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_extra_days: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_rejected: typing.Optional[bool] = pydantic.Field(
        False,
    )


class tagsCreate(pydantic.BaseModel):
    is_atr_uploaded: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_maintenance_exception: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_revocation: typing.Optional[bool] = pydantic.Field(
        False,
    )
    no_exception: typing.Optional[bool] = pydantic.Field(
        False,
    ...
    is_un_blocked: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_interrupt: typing.Optional[bool] = pydantic.Field(
        False,
...
class InterlockSchema(UrdhvaPostgresBase):
    ...
    interlock_name: Mapped[typing.Optional[str]] = mapped_column(
        "interlock_name",
        String,
        index=True,
        nullable=True,
    ...
    device_name: Mapped[typing.Optional[str]] = mapped_column(
        "device_name",
        String,
        index=False,
        nullable=True,
    ...
    device_type: Mapped[typing.Optional[str]] = mapped_column(
        "device_type",
        String,
        index=False,
        nullable=True,
    ...
    device_id: Mapped[typing.Optional[str]] = mapped_column(
        "device_id",
        String,
        index=False,
        nullable=True,
    ...
    interlock_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "interlock_status",
        String,
        index=False,
        nullable=True,
...
class EMLockSchema(UrdhvaPostgresBase):
    ...
    violation_start_date: Mapped[datetime.datetime] = mapped_column(
    ...
    violation_history: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "violation_history",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    status: Mapped[typing.Any] = mapped_column(
        "status",
        String,
        index=False,
        nullable=False,
...
class VTSSchema(UrdhvaPostgresBase):
    ...
    violation_start_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "violation_start_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    block_duration: Mapped[typing.Optional[str]] = mapped_column(
        "block_duration",
        String,
        index=False,
        nullable=True,
    ...
    block_msg: Mapped[typing.Optional[str]] = mapped_column(
        "block_msg",
        String,
        index=False,
        nullable=True,
    ...
    status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "status",
        String,
        index=False,
        nullable=True,
    ...
    report_duration: Mapped[typing.Optional[str]] = mapped_column(
        "report_duration",
        String,
        index=False,
        nullable=True,
    ...
    total_trips: Mapped[typing.Optional[int]] = mapped_column(
        "total_trips",
        Integer,
        index=False,
        nullable=True,
...
class VtsManualBlockedSchema(UrdhvaPostgresBase):
    ...
    blocked_by: Mapped[typing.Optional[str]] = mapped_column(
        "blocked_by",
        String,
        index=False,
        nullable=True,
    ...
    unblocked_by: Mapped[typing.Optional[str]] = mapped_column(
        "unblocked_by",
        String,
        index=False,
        nullable=True,
    ...
    blocked_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "blocked_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    unblocked_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "unblocked_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    blocking_status: Mapped[typing.Optional[str]] = mapped_column(
        "blocking_status",
        String,
        index=True,
        nullable=True,
    ...
    blocking_flag: Mapped[typing.Optional[str]] = mapped_column(
        "blocking_flag",
        String,
        index=False,
        nullable=True,
    ...
    blocking_days: Mapped[typing.Optional[int]] = mapped_column(
        "blocking_days",
        Integer,
        index=False,
        nullable=True,
    ...
    blocking_from: Mapped[datetime.datetime] = mapped_column(
        "blocking_from",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    blocking_to: Mapped[datetime.datetime] = mapped_column(
        "blocking_to",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    remarks_unblocked: Mapped[typing.Optional[str]] = mapped_column(
        "remarks_unblocked",
        String,
        index=False,
        nullable=True,
    ...
    file_uploaded_path: Mapped[typing.Optional[str]] = mapped_column(
        "file_uploaded_path",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            transaction_number, name="vts_manual_blocked_transaction_number"
        ),
    )
...
class AlertsSchema(UrdhvaPostgresBase):
    ...
    bu: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "bu",
        String,
        index=True,
        nullable=True,
    ...
    severity: Mapped[typing.Any] = mapped_column(
        "severity",
        String,
        index=True,
        nullable=False,
    ...
    alert_category: Mapped[typing.Optional[str]] = mapped_column(
        "alert_category",
        String,
        index=False,
        nullable=True,
    ...
    alert_status: Mapped[typing.Any] = mapped_column(
        "alert_status",
        String,
        index=True,
        nullable=False,
    ...
    alert_state: Mapped[typing.Any] = mapped_column(
        "alert_state",
        String,
        index=False,
        nullable=False,
    ...
    alert_section: Mapped[str] = mapped_column(
        "alert_section",
        String,
        index=False,
        nullable=False,
    ...
    external_id: Mapped[typing.Optional[str]] = mapped_column(
        "external_id",
        String,
        index=True,
        nullable=True,
    ...
    interlock_id: Mapped[typing.Optional[str]] = mapped_column(
        "interlock_id",
        String,
        index=False,
        nullable=True,
    ...
    equipment_id: Mapped[typing.Optional[str]] = mapped_column(
        "equipment_id",
        String,
        index=False,
        nullable=True,
    ...
    sensor_id: Mapped[typing.Optional[str]] = mapped_column(
        "sensor_id",
        String,
        index=False,
        nullable=True,
    ...
    equipment_type: Mapped[typing.Optional[str]] = mapped_column(
        "equipment_type",
        String,
        index=False,
        nullable=True,
    ...
    equipment_name: Mapped[typing.Optional[str]] = mapped_column(
        "equipment_name",
        String,
        index=False,
        nullable=True,
    ...
    tas_device_name: Mapped[typing.Optional[str]] = mapped_column(
        "tas_device_name",
        String,
        index=False,
        nullable=True,
    ...
    device_msg: Mapped[typing.Optional[str]] = mapped_column(
        "device_msg",
        String,
        index=False,
        nullable=True,
    ...
    vehicle_number: Mapped[typing.Optional[str]] = mapped_column(
        "vehicle_number",
        String,
        index=False,
        nullable=True,
    ...
    violation_type: Mapped[typing.Optional[str]] = mapped_column(
        "violation_type",
        String,
        index=True,
        nullable=True,
    ...
    clear_count: Mapped[typing.Optional[bool]] = mapped_column(
        "clear_count",
        Boolean,
        index=False,
        nullable=True,
    ...
    maintenance_time: Mapped[typing.Optional[str]] = mapped_column(
        "maintenance_time",
        String,
        index=False,
        nullable=True,
    ...
    closed_at: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "closed_at",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    cause_effect: Mapped[typing.Optional[str]] = mapped_column(
        "cause_effect",
        String,
        index=False,
        nullable=True,
    ...
    alert_closure_reason: Mapped[typing.Optional[str]] = mapped_column(
    ...
    tt_load_number: Mapped[typing.Optional[str]] = mapped_column(
        "tt_load_number",
        String,
        index=False,
        nullable=True,
    ...
    is_flagged_false: Mapped[typing.Optional[bool]] = mapped_column(
        "is_flagged_false",
        Boolean,
        index=False,
        nullable=True,
    ...
    rca: Mapped[typing.Optional[str]] = mapped_column(
        "rca",
        String,
        index=False,
        nullable=True,
    ...
    rca_type: Mapped[typing.Optional[str]] = mapped_column(
        "rca_type",
        String,
        index=False,
        nullable=True,
    ...
    alert_history: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "alert_history",
        JSONB,
        index=False,
        nullable=True,
    ...
    last_sms_to: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "last_sms_to",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    last_mailed_to: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "last_mailed_to",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    last_escalated_to: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "last_escalated_to",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    last_notified_to: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "last_notified_to",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    assigned_to: Mapped[typing.Optional[str]] = mapped_column(
        "assigned_to",
        String,
        index=False,
        nullable=True,
    ...
    assigned_to_role: Mapped[typing.Optional[str]] = mapped_column(
        "assigned_to_role",
        String,
        index=False,
        nullable=True,
    ...
    assigned_users: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "assigned_users",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    assigned_user_roles: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "assigned_user_roles",
        ARRAY(String),
        index=True,
        nullable=True,
    ...
    raw_data: Mapped[typing.Optional[dict]] = mapped_column(
        "raw_data",
        JSONB,
        index=False,
        nullable=True,
    ...
    r1_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "r1_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    r2_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "r2_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    r3_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "r3_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    indent_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "indent_status",
        String,
        index=True,
        nullable=True,
    ...
    product_code: Mapped[typing.Optional[str]] = mapped_column(
        "product_code",
        String,
        index=True,
        nullable=True,
    ...
    indent_no: Mapped[typing.Optional[str]] = mapped_column(
        "indent_no",
        String,
        index=False,
        nullable=True,
    ...
    dealer_id: Mapped[typing.Optional[str]] = mapped_column(
        "dealer_id",
        String,
        index=False,
        nullable=True,
    ...
    workflow_instance_id: Mapped[typing.Optional[str]] = mapped_column(
    ...
    workflow_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "workflow_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    workflow_url: Mapped[typing.Optional[str]] = mapped_column(
        "workflow_url",
        String,
        index=False,
        nullable=True,
    ...
    workflow_port: Mapped[typing.Optional[str]] = mapped_column(
        "workflow_port",
        String,
        index=False,
        nullable=True,
    ...
    servicing_plant_id: Mapped[typing.Optional[str]] = mapped_column(
        "servicing_plant_id",
        String,
        index=False,
        nullable=True,
    ...
    servicing_plant_name: Mapped[typing.Optional[str]] = mapped_column(
    ...
    progress_rate: Mapped[typing.Optional[int]] = mapped_column(
        "progress_rate",
        Integer,
        index=True,
        nullable=True,
    ...
    indent_raised_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "indent_raised_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    dry_out_in_days: Mapped[typing.Optional[str]] = mapped_column(
        "dry_out_in_days",
        String,
        index=True,
        nullable=True,
    ...
    origin_altid: Mapped[typing.Optional[str]] = mapped_column(
        "origin_altid",
        String,
        index=False,
        nullable=True,
    ...
    alert_message: Mapped[typing.Optional[str]] = mapped_column(
        "alert_message",
        String,
        index=False,
        nullable=True,
    ...
    external_timestamp: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "external_timestamp",
    ...
    atg_ack: Mapped[typing.Optional[bool]] = mapped_column(
        "atg_ack",
        Boolean,
        index=False,
        nullable=True,
    ...
    emlock_ack: Mapped[typing.Optional[bool]] = mapped_column(
        "emlock_ack",
        Boolean,
        index=False,
        nullable=True,
    ...
    vts_return: Mapped[typing.Optional[bool]] = mapped_column(
        "vts_return",
        Boolean,
        index=False,
        nullable=True,
    ...
    atg_ack_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "atg_ack_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    dry_out_start_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "dry_out_start_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    dry_out_end_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "dry_out_end_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    intra_day_dry_out_start_time: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
            "intra_day_dry_out_start_time",
            DateTime(timezone=True),
            index=False,
            nullable=True,
            default=None,
    ...
    intra_day_dry_out_end_time: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
            "intra_day_dry_out_end_time",
            DateTime(timezone=True),
            index=False,
            nullable=True,
            default=None,
    ...
    temporary_close: Mapped[typing.Optional[bool]] = mapped_column(
        "temporary_close",
        Boolean,
        index=False,
        nullable=True,
    ...
    permanent_close: Mapped[typing.Optional[bool]] = mapped_column(
        "permanent_close",
        Boolean,
        index=False,
        nullable=True,
    ...
    ro_offline: Mapped[typing.Optional[bool]] = mapped_column(
        "ro_offline",
        Boolean,
        index=False,
        nullable=True,
    ...
    transporter_name: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_name",
        String,
        index=False,
        nullable=True,
    ...
    transporter_code: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_code",
        String,
        index=False,
        nullable=True,
    ...
    vehicle_blocked_start_date: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    vehicle_blocked_end_date: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    vehicle_unblocked_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "vehicle_unblocked_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    mark_as_false: Mapped[typing.Optional[bool]] = mapped_column(
        "mark_as_false",
        Boolean,
        index=True,
        nullable=True,
    ...
    vts_alert_history_ids: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
    ...
    action_on: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "action_on",
        String,
        index=False,
        nullable=True,
    ...
    block_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "block_status",
        String,
        index=True,
        nullable=True,
    ...
    image_uploaded: Mapped[typing.Optional[bool]] = mapped_column(
        "image_uploaded",
        Boolean,
        index=False,
        nullable=True,
    ...
    tt_type: Mapped[typing.Optional[str]] = mapped_column(
        "tt_type",
        String,
        index=False,
        nullable=True,
    ...
    ticket_id: Mapped[typing.Optional[str]] = mapped_column(
        "ticket_id",
        String,
        index=False,
        nullable=True,
    ...
    load_type: Mapped[typing.Optional[str]] = mapped_column(
        "load_type",
        String,
        index=False,
        nullable=True,
    ...
    auto_close: Mapped[typing.Optional[bool]] = mapped_column(
        "auto_close",
        Boolean,
        index=False,
        nullable=True,
...
class AlertsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    clear_count: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    is_flagged_false: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    city: typing.Optional[str] = pydantic.Field("", **{})
    sales_area: typing.Optional[str] = pydantic.Field("", **{})
    raw_data: typing.Optional[dict] = pydantic.Field(
        pydantic.Field(default_factory=dict),
    )
    ...
    atg_ack: typing.Optional[bool] = pydantic.Field(
        False,
    )
    emlock_ack: typing.Optional[bool] = pydantic.Field(
        False,
    )
    vts_return: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    temporary_close: typing.Optional[bool] = pydantic.Field(
        False,
    )
    permanent_close: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ro_offline: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    mark_as_false: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    image_uploaded: typing.Optional[bool] = pydantic.Field(
        False,
    )
    ...
    auto_close: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class CEMSLocationMasterSchema(UrdhvaPostgresBase):
    ...
    zonal_id: Mapped[str] = mapped_column(
        "zonal_id",
        String,
        index=False,
        nullable=False,
...
class CEMSQuantityMasterSchema(UrdhvaPostgresBase):
    ...
    quantity_id: Mapped[str] = mapped_column(
        "quantity_id",
        String,
        index=False,
        nullable=False,
...
class CredsModelSchema(UrdhvaPostgresBase):
    ...
    cred_model: Mapped[str] = mapped_column(
        "cred_model",
        String,
        index=False,
        nullable=False,
    ...
    credentials: Mapped[typing.Any] = mapped_column(
        "credentials",
        JSONB,
        index=False,
        nullable=False,
...
class CarryFwdIndentSchema(UrdhvaPostgresBase):
    ...
    prod_reqd_dt: Mapped[datetime.datetime] = mapped_column(
        "prod_reqd_dt",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    reported_date: Mapped[datetime.datetime] = mapped_column(
        "reported_date",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    dried_out: Mapped[typing.Optional[bool]] = mapped_column(
        "dried_out",
        Boolean,
        index=False,
        nullable=True,
...
class CarryFwdIndentCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    dry_out_in_days: typing.Optional[str] = pydantic.Field("", **{})
    dried_out: typing.Optional[bool] = pydantic.Field(
        False,
    )
    category: typing.Optional[str] = pydantic.Field("", **{})
...
class IndentDryOutSchema(UrdhvaPostgresBase):
    ...
    fcc_code: Mapped[str] = mapped_column(
        "fcc_code",
        String,
        index=False,
        nullable=False,
    ...
    volume: Mapped[typing.Optional[float]] = mapped_column(
        "volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    ullage: Mapped[typing.Optional[float]] = mapped_column(
        "ullage",
        Numeric,
        index=False,
        nullable=True,
    ...
    avgsales_7days: Mapped[typing.Optional[float]] = mapped_column(
        "avgsales_7days",
        Numeric,
        index=False,
        nullable=True,
    ...
    stock_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "stock_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    status: Mapped[typing.Optional[int]] = mapped_column(
        "status",
        Integer,
        index=False,
        nullable=True,
    ...
    daysstatus: Mapped[typing.Optional[int]] = mapped_column(
        "daysstatus",
        Integer,
        index=False,
        nullable=True,
    ...
    lastrocdate: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "lastrocdate",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    executed_on: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "executed_on",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    pumpable_stock: Mapped[typing.Optional[float]] = mapped_column(
        "pumpable_stock",
        Numeric,
        index=False,
        nullable=True,
    ...
    rosapcode: Mapped[typing.Optional[int]] = mapped_column(
        "rosapcode",
        Integer,
        index=True,
        nullable=True,
    ...
    product_grp: Mapped[typing.Optional[str]] = mapped_column(
        "product_grp",
        String,
        index=False,
        nullable=True,
    ...
    interlock_created_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "interlock_created_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    interlock_closed_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "interlock_closed_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    __table_args__ = (
        UniqueConstraint(
            bu, product_no, rosapcode, name="indent_dry_out_bu_product_no_rosapcode"
        ),
    )
...
class Indentdryout_Get_Distinct_Location_DetailsParams(pydantic.BaseModel):
    ...
    cat_a_dealers: typing.Optional[bool] = pydantic.Field(
        False,
    )
    dry_out_dealers: typing.Optional[bool] = pydantic.Field(
        False,
    )
    location_onboard: typing.Optional[bool] = pydantic.Field(
        False,
...
class LpgPlantOperationsSchema(UrdhvaPostgresBase):
    ...
    carousel: Mapped[str] = mapped_column(
        "carousel",
        String,
        index=True,
        nullable=False,
    ...
    filling_head: Mapped[str] = mapped_column(
        "filling_head",
        String,
        index=True,
        nullable=False,
    ...
    normal_net_hours: Mapped[typing.Optional[float]] = mapped_column(
        "normal_net_hours",
        Numeric,
        index=False,
        nullable=True,
    ...
    normal_gap_hrs: Mapped[typing.Optional[float]] = mapped_column(
        "normal_gap_hrs",
        Numeric,
        index=False,
        nullable=True,
    ...
    normal_total_production: Mapped[typing.Optional[float]] = mapped_column(
    ...
    normal_productivity: Mapped[typing.Optional[float]] = mapped_column(
        "normal_productivity",
        Numeric,
        index=False,
        nullable=True,
    ...
    break_net_hours: Mapped[typing.Optional[float]] = mapped_column(
        "break_net_hours",
        Numeric,
        index=False,
        nullable=True,
    ...
    break_gap_hrs: Mapped[typing.Optional[float]] = mapped_column(
        "break_gap_hrs",
        Numeric,
        index=False,
        nullable=True,
    ...
    break_total_production: Mapped[typing.Optional[float]] = mapped_column(
    ...
    break_productivity: Mapped[typing.Optional[float]] = mapped_column(
        "break_productivity",
        Numeric,
        index=False,
        nullable=True,
    ...
    overtime_net_hours: Mapped[typing.Optional[float]] = mapped_column(
        "overtime_net_hours",
        Numeric,
        index=False,
        nullable=True,
    ...
    overtime_gap_hrs: Mapped[typing.Optional[float]] = mapped_column(
        "overtime_gap_hrs",
        Numeric,
        index=False,
        nullable=True,
    ...
    overtime_total_production: Mapped[typing.Optional[float]] = mapped_column(
    ...
    overtime_productivity: Mapped[typing.Optional[float]] = mapped_column(
    ...
    total_net_hours: Mapped[typing.Optional[float]] = mapped_column(
        "total_net_hours",
        Numeric,
        index=False,
        nullable=True,
    ...
    total_production: Mapped[typing.Optional[float]] = mapped_column(
        "total_production",
        Numeric,
        index=False,
        nullable=True,
    ...
    total_productivity: Mapped[typing.Optional[float]] = mapped_column(
        "total_productivity",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_handled: Mapped[typing.Optional[float]] = mapped_column(
        "cs_handled",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_sortout: Mapped[typing.Optional[float]] = mapped_column(
        "cs_sortout",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_rejection: Mapped[typing.Optional[float]] = mapped_column(
        "cs_rejection",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_underfilled: Mapped[typing.Optional[float]] = mapped_column(
        "cs_underfilled",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_overfilled: Mapped[typing.Optional[float]] = mapped_column(
        "cs_overfilled",
        Numeric,
        index=False,
        nullable=True,
    ...
    cs_other_errors: Mapped[typing.Optional[float]] = mapped_column(
        "cs_other_errors",
        Numeric,
        index=False,
        nullable=True,
    ...
    gd_handled: Mapped[typing.Optional[float]] = mapped_column(
        "gd_handled",
        Numeric,
        index=False,
        nullable=True,
    ...
    gd_sortout: Mapped[typing.Optional[float]] = mapped_column(
        "gd_sortout",
        Numeric,
        index=False,
        nullable=True,
    ...
    gd_rejection: Mapped[typing.Optional[float]] = mapped_column(
        "gd_rejection",
        Numeric,
        index=False,
        nullable=True,
    ...
    pt_handled: Mapped[typing.Optional[float]] = mapped_column(
        "pt_handled",
        Numeric,
        index=False,
        nullable=True,
    ...
    pt_sortout: Mapped[typing.Optional[float]] = mapped_column(
        "pt_sortout",
        Numeric,
        index=False,
        nullable=True,
    ...
    pt_rejection: Mapped[typing.Optional[float]] = mapped_column(
        "pt_rejection",
        Numeric,
        index=False,
        nullable=True,
    ...
    production_14_2kg: Mapped[typing.Optional[float]] = mapped_column(
        "production_14_2kg",
        Numeric,
        index=False,
        nullable=True,
    ...
    production_19kg: Mapped[typing.Optional[float]] = mapped_column(
        "production_19kg",
        Numeric,
        index=False,
        nullable=True,
    ...
    fst_cyl_production: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "fst_cyl_production",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    lst_cyl_production: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "lst_cyl_production",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    total_bottling_hours: Mapped[typing.Optional[float]] = mapped_column(
        "total_bottling_hours",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    net_bottling_hours: Mapped[typing.Optional[float]] = mapped_column(
        "net_bottling_hours",
        Numeric,
        index=False,
        nullable=True,
    ...
    stoppage_hours: Mapped[typing.Optional[float]] = mapped_column(
        "stoppage_hours",
        Numeric,
        index=False,
        nullable=True,
...
class LpgOperationsSummarySchema(UrdhvaPostgresBase):
    ...
    is_additional_carousel: Mapped[float] = mapped_column(
        "is_additional_carousel",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    carousel: Mapped[float] = mapped_column(
        "carousel",
        Numeric,
        index=False,
        nullable=False,
    ...
    filling_heads: Mapped[str] = mapped_column(
        "filling_heads",
        String,
        index=False,
        nullable=False,
    ...
    carousel_count: Mapped[float] = mapped_column(
        "carousel_count",
        Numeric,
        index=False,
        nullable=False,
    ...
    bottling_14_2kg: Mapped[float] = mapped_column(
        "bottling_14_2kg",
        Numeric,
        index=False,
        nullable=False,
    ...
    bottling_19kg: Mapped[float] = mapped_column(
        "bottling_19kg",
        Numeric,
        index=False,
        nullable=False,
    ...
    bottling_total: Mapped[float] = mapped_column(
        "bottling_total",
        Numeric,
        index=False,
        nullable=False,
    ...
    productivity_normal_production: Mapped[float] = mapped_column(
        "productivity_normal_production",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_normal_stoppages: Mapped[float] = mapped_column(
        "productivity_normal_stoppages",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_normal_productivity: Mapped[float] = mapped_column(
        "productivity_normal_productivity",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_break_production: Mapped[float] = mapped_column(
        "productivity_break_production",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_break_net_hours: Mapped[float] = mapped_column(
        "productivity_break_net_hours",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_break_productivity: Mapped[float] = mapped_column(
        "productivity_break_productivity",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_overtime_production: Mapped[float] = mapped_column(
        "productivity_overtime_production",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_overtime_net_hours: Mapped[float] = mapped_column(
        "productivity_overtime_net_hours",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    productivity_overtime_productivity: Mapped[float] = mapped_column(
        "productivity_overtime_productivity",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    rejection_eld_percent: Mapped[float] = mapped_column(
        "rejection_eld_percent",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    rejection_ort_percent: Mapped[float] = mapped_column(
        "rejection_ort_percent",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    rejection_cs_percent: Mapped[float] = mapped_column(
        "rejection_cs_percent",
        Numeric,
        index=False,
        nullable=False,
        default=None,
    ...
    site_area: Mapped[str] = mapped_column(
        "site_area",
        String,
        index=False,
        nullable=False,
...
class LpgCsRejectionsSchema(UrdhvaPostgresBase):
    ...
    system_id: Mapped[float] = mapped_column(
        "system_id",
        Numeric,
        index=False,
        nullable=False,
    ...
    cyl_type: Mapped[str] = mapped_column(
        "cyl_type",
        String,
        index=False,
        nullable=False,
    ...
    cylfilled: Mapped[float] = mapped_column(
        "cylfilled",
        Numeric,
        index=False,
        nullable=False,
    ...
    totalsortout: Mapped[float] = mapped_column(
        "totalsortout",
        Numeric,
        index=False,
        nullable=False,
    ...
    commerrorsortout: Mapped[float] = mapped_column(
        "commerrorsortout",
        Numeric,
        index=False,
        nullable=False,
    ...
    sortoutpercentage: Mapped[float] = mapped_column(
        "sortoutpercentage",
        Numeric,
        index=False,
        nullable=False,
    ...
    execution__date: Mapped[datetime.datetime] = mapped_column(
        "execution__date",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    max_date: Mapped[datetime.datetime] = mapped_column(
        "max_date",
        DateTime(timezone=True),
        index=False,
        nullable=False,
...
class LpgGdRejectionsSchema(UrdhvaPostgresBase):
    ...
    sortout: Mapped[float] = mapped_column(
        "sortout",
        Numeric,
        index=False,
        nullable=False,
...
class LpgSalesSummaryDataSchema(UrdhvaPostgresBase):
    ...
    jde_distributor_code: Mapped[int] = mapped_column(
        "jde_distributor_code",
        Integer,
        index=False,
        nullable=False,
        default=None,
    ...
    is_prepaid: Mapped[str] = mapped_column(
        "is_prepaid",
        String,
        index=False,
        nullable=False,
    ...
    order_source_code: Mapped[str] = mapped_column(
        "order_source_code",
        String,
        index=False,
        nullable=False,
    ...
    pending_0_d: Mapped[int] = mapped_column(
        "pending_0_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_1_d: Mapped[int] = mapped_column(
        "pending_1_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_2_d: Mapped[int] = mapped_column(
        "pending_2_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_3_d: Mapped[int] = mapped_column(
        "pending_3_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_4_d: Mapped[int] = mapped_column(
        "pending_4_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_5_d: Mapped[int] = mapped_column(
        "pending_5_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_6_d: Mapped[int] = mapped_column(
        "pending_6_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_7_d: Mapped[int] = mapped_column(
        "pending_7_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_8_d: Mapped[int] = mapped_column(
        "pending_8_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_9_d: Mapped[int] = mapped_column(
        "pending_9_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_10_d: Mapped[int] = mapped_column(
        "pending_10_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_11_d: Mapped[int] = mapped_column(
        "pending_11_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_12_d: Mapped[int] = mapped_column(
        "pending_12_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_13_d: Mapped[int] = mapped_column(
        "pending_13_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_14_d: Mapped[int] = mapped_column(
        "pending_14_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_15_d: Mapped[int] = mapped_column(
        "pending_15_d",
        Integer,
        index=False,
        nullable=False,
    ...
    pending__beyond15_d: Mapped[int] = mapped_column(
        "pending__beyond15_d",
        Integer,
        index=False,
        nullable=False,
    ...
    booking_received_yesterday: Mapped[int] = mapped_column(
        "booking_received_yesterday",
        Integer,
        index=False,
        nullable=False,
        default=None,
    ...
    total_sales_yesterday: Mapped[int] = mapped_column(
    ...
    booking_received_today: Mapped[int] = mapped_column(
        "booking_received_today",
        Integer,
        index=False,
        nullable=False,
        default=None,
    ...
    total_sales_today: Mapped[int] = mapped_column(
        "total_sales_today",
        Integer,
        index=False,
        nullable=False,
    ...
    sa_code: Mapped[int] = mapped_column(
        "sa_code",
        Integer,
        index=False,
        nullable=False,
    ...
    taluka_code: Mapped[str] = mapped_column(
        "taluka_code",
        String,
        index=False,
        nullable=False,
    ...
    ro_code: Mapped[int] = mapped_column(
        "ro_code",
        Integer,
        index=False,
        nullable=False,
    ...
    sa_name: Mapped[str] = mapped_column(
        "sa_name",
        String,
        index=False,
        nullable=False,
    ...
    zo_code: Mapped[str] = mapped_column(
        "zo_code",
        String,
        index=False,
        nullable=False,
    ...
    ro_name: Mapped[str] = mapped_column(
        "ro_name",
        String,
        index=False,
        nullable=False,
    ...
    zo_name: Mapped[str] = mapped_column(
        "zo_name",
        String,
        index=False,
        nullable=False,
    ...
    order_source_name: Mapped[str] = mapped_column(
        "order_source_name",
        String,
        index=False,
        nullable=False,
    ...
    total__pending: Mapped[int] = mapped_column(
        "total__pending",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_1_3_days: Mapped[int] = mapped_column(
        "pending_1_3_days",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_4_7_days: Mapped[int] = mapped_column(
        "pending_4_7_days",
        Integer,
        index=False,
        nullable=False,
    ...
    pending_8_15_days: Mapped[int] = mapped_column(
        "pending_8_15_days",
        Integer,
        index=False,
        nullable=False,
    ...
    execution__month: Mapped[str] = mapped_column(
        "execution__month",
        String,
        index=False,
        nullable=False,
    ...
    execution__year: Mapped[int] = mapped_column(
        "execution__year",
        Integer,
        index=False,
        nullable=False,
    ...
    month__year: Mapped[str] = mapped_column(
        "month__year",
        String,
        index=False,
        nullable=False,
...
class LpgConsumersSummarySchema(UrdhvaPostgresBase):
    ...
    distributor_code: Mapped[int] = mapped_column(
        "distributor_code",
        Integer,
        index=False,
        nullable=False,
    ...
    relationship_sub_status: Mapped[str] = mapped_column(
        "relationship_sub_status",
        String,
        index=False,
        nullable=False,
        default=None,
    ...
    consumer_category: Mapped[str] = mapped_column(
        "consumer_category",
        String,
        index=False,
        nullable=False,
    ...
    typeof_consumer: Mapped[int] = mapped_column(
        "typeof_consumer",
        Integer,
        index=False,
        nullable=False,
    ...
    main_scheme_category: Mapped[int] = mapped_column(
        "main_scheme_category",
        Integer,
        index=False,
        nullable=False,
        default=None,
    ...
    cylinder_type: Mapped[str] = mapped_column(
        "cylinder_type",
        String,
        index=False,
        nullable=False,
    ...
    e_kyc_completed: Mapped[int] = mapped_column(
        "e_kyc_completed",
        Integer,
        index=False,
        nullable=False,
    ...
    suvidha_club: Mapped[int] = mapped_column(
        "suvidha_club",
        Integer,
        index=False,
        nullable=False,
    ...
    hig_opt_out: Mapped[int] = mapped_column(
        "hig_opt_out",
        Integer,
        index=False,
        nullable=False,
    ...
    subsidy_give_it_up: Mapped[int] = mapped_column(
        "subsidy_give_it_up",
        Integer,
        index=False,
        nullable=False,
    ...
    actc_count: Mapped[int] = mapped_column(
        "actc_count",
        Integer,
        index=False,
        nullable=False,
    ...
    bctc_count: Mapped[int] = mapped_column(
        "bctc_count",
        Integer,
        index=False,
        nullable=False,
    ...
    nctc_count: Mapped[int] = mapped_column(
        "nctc_count",
        Integer,
        index=False,
        nullable=False,
    ...
    safety_check_pending: Mapped[int] = mapped_column(
    ...
    hp_pay_consumer_count: Mapped[int] = mapped_column(
        "hp_pay_consumer_count",
        Integer,
        index=False,
        nullable=False,
        default=None,
    ...
    e_kyc_pending: Mapped[int] = mapped_column(
        "e_kyc_pending",
        Integer,
        index=False,
        nullable=False,
    ...
    zone_names: Mapped[str] = mapped_column(
        "zone_names",
        String,
        index=False,
        nullable=False,
...
class ScreensSchema(UrdhvaPostgresBase):
    ...
    dashboards: Mapped[typing.List[int]] = mapped_column(
        "dashboards",
        ARRAY(Integer),
        index=False,
        nullable=False,
    ...
    updated_by: Mapped[typing.Optional[str]] = mapped_column(
        "updated_by",
        String,
        index=False,
        nullable=True,
    ...
    x: Mapped[typing.Optional[int]] = mapped_column(
        "x",
        Integer,
        index=False,
        nullable=True,
    ...
    y: Mapped[typing.Optional[int]] = mapped_column(
        "y",
        Integer,
        index=False,
        nullable=True,
    ...
    w: Mapped[typing.Optional[int]] = mapped_column(
        "w",
        Integer,
        index=False,
        nullable=True,
    ...
    h: Mapped[typing.Optional[int]] = mapped_column(
        "h",
        Integer,
        index=False,
        nullable=True,
    ...
    static: Mapped[typing.Optional[bool]] = mapped_column(
        "static",
        Boolean,
        index=False,
        nullable=True,
    ...
    moved: Mapped[typing.Optional[bool]] = mapped_column(
        "moved",
        Boolean,
        index=False,
        nullable=True,
...
class DeviceMasterSchema(UrdhvaPostgresBase):
    ...
    device_type: Mapped[typing.Any] = mapped_column(
        "device_type",
        String,
        index=False,
        nullable=False,
    ...
    tank_no: Mapped[typing.Optional[str]] = mapped_column(
        "tank_no",
        String,
        index=False,
        nullable=True,
    ...
    tank_name: Mapped[typing.Optional[str]] = mapped_column(
        "tank_name",
        String,
        index=False,
        nullable=True,
    ...
    tank_capacity: Mapped[typing.Optional[int]] = mapped_column(
        "tank_capacity",
        Integer,
        index=False,
        nullable=True,
    ...
    pump_no: Mapped[typing.Optional[int]] = mapped_column(
        "pump_no",
        Integer,
        index=False,
        nullable=True,
    ...
    du_no: Mapped[typing.Optional[int]] = mapped_column(
        "du_no",
        Integer,
        index=False,
        nullable=True,
    ...
    nozzle_no: Mapped[typing.Optional[int]] = mapped_column(
        "nozzle_no",
        Integer,
        index=False,
        nullable=True,
    ...
    global_nozzle_no: Mapped[typing.Optional[int]] = mapped_column(
        "global_nozzle_no",
        Integer,
        index=False,
        nullable=True,
...
class VtsAlertHistorySchema(UrdhvaPostgresBase):
    ...
    vendor_id: Mapped[typing.Optional[str]] = mapped_column(
        "vendor_id",
        String,
        index=False,
        nullable=True,
    ...
    location_id: Mapped[typing.Optional[str]] = mapped_column(
        "location_id",
        String,
        index=False,
        nullable=True,
    ...
    base_location_id: Mapped[typing.Optional[str]] = mapped_column(
        "base_location_id",
        String,
        index=False,
        nullable=True,
    ...
    bu: Mapped[typing.Optional[str]] = mapped_column(
        "bu",
        String,
        index=False,
        nullable=True,
    ...
    base_zone: Mapped[typing.Optional[str]] = mapped_column(
        "base_zone",
        String,
        index=False,
        nullable=True,
    ...
    base_location_name: Mapped[typing.Optional[str]] = mapped_column(
        "base_location_name",
        String,
        index=False,
        nullable=True,
    ...
    base_region: Mapped[typing.Optional[str]] = mapped_column(
        "base_region",
        String,
        index=False,
        nullable=True,
    ...
    location_type: Mapped[typing.Optional[str]] = mapped_column(
        "location_type",
        String,
        index=False,
        nullable=True,
    ...
    tl_number: Mapped[str] = mapped_column(
        "tl_number",
        String,
        index=True,
        nullable=False,
    ...
    vts_start_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "vts_start_datetime",
        DateTime(timezone=False),
        index=False,
        nullable=True,
    ...
    vts_end_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "vts_end_datetime",
        DateTime(timezone=False),
        index=False,
        nullable=True,
    ...
    stoppage_violations_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    route_deviation_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    route_deviation_count_orig: Mapped[typing.Optional[int]] = mapped_column(
    ...
    scheduled_trip_start_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    scheduled_trip_end_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    speed_violation_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    main_supply_removal_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    night_driving_count: Mapped[typing.Optional[int]] = mapped_column(
        "night_driving_count",
        Integer,
        index=False,
        nullable=True,
    ...
    no_halt_zone_count: Mapped[typing.Optional[int]] = mapped_column(
        "no_halt_zone_count",
        Integer,
        index=False,
        nullable=True,
    ...
    device_offline_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    device_tamper_count: Mapped[typing.Optional[int]] = mapped_column(
        "device_tamper_count",
        Integer,
        index=False,
        nullable=True,
    ...
    continuous_driving_count: Mapped[typing.Optional[int]] = mapped_column(
    ...
    approved_by: Mapped[typing.Optional[str]] = mapped_column(
        "approved_by",
        String,
        index=False,
        nullable=True,
    ...
    auto_unblock: Mapped[typing.Optional[bool]] = mapped_column(
        "auto_unblock",
        Boolean,
        index=False,
        nullable=True,
    ...
    invoice_number: Mapped[typing.Optional[str]] = mapped_column(
        "invoice_number",
        String,
        index=True,
        nullable=True,
    ...
    violation_type: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "violation_type",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    destination_code: Mapped[typing.Optional[str]] = mapped_column(
        "destination_code",
        String,
        index=False,
        nullable=True,
...
class VtsAlertHistoryCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    auto_unblock: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class EmLockAlertHistorySchema(UrdhvaPostgresBase):
    ...
    emlock_exception_id: Mapped[str] = mapped_column(
        "emlock_exception_id",
        String,
        index=False,
        nullable=False,
    ...
    ro_code: Mapped[typing.Optional[str]] = mapped_column(
        "ro_code",
        String,
        index=False,
        nullable=True,
...
class VaAlertHistorySchema(UrdhvaPostgresBase):
    ...
    alert_type: Mapped[typing.Optional[str]] = mapped_column(
        "alert_type",
        String,
        index=False,
        nullable=True,
    ...
    alert_description: Mapped[typing.Optional[str]] = mapped_column(
        "alert_description",
        String,
        index=False,
        nullable=True,
    ...
    video_url: Mapped[typing.Optional[str]] = mapped_column(
        "video_url",
        String,
        index=False,
        nullable=True,
    ...
    alert_timestamp: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "alert_timestamp",
        DateTime(timezone=False),
        index=False,
        nullable=True,
    ...
    acknowledged_by: Mapped[typing.Optional[str]] = mapped_column(
        "acknowledged_by",
        String,
        index=False,
        nullable=True,
    ...
    action_description: Mapped[typing.Optional[str]] = mapped_column(
        "action_description",
        String,
        index=False,
        nullable=True,
    ...
    action_code: Mapped[typing.Optional[str]] = mapped_column(
        "action_code",
        String,
        index=False,
        nullable=True,
    ...
    action_reason: Mapped[typing.Optional[str]] = mapped_column(
        "action_reason",
        String,
        index=False,
        nullable=True,
    ...
    action_category: Mapped[typing.Optional[str]] = mapped_column(
        "action_category",
        String,
        index=False,
        nullable=True,
...
class M60LevelMetaDataSchema(UrdhvaPostgresBase):
    ...
    sbu: Mapped[typing.Optional[str]] = mapped_column(
        "sbu",
        String,
        index=False,
        nullable=True,
    ...
    sbu__name: Mapped[typing.Optional[str]] = mapped_column(
        "sbu__name",
        String,
        index=False,
        nullable=True,
    ...
    zone__name: Mapped[typing.Optional[str]] = mapped_column(
        "zone__name",
        String,
        index=False,
        nullable=True,
    ...
    region__name: Mapped[typing.Optional[str]] = mapped_column(
        "region__name",
        String,
        index=False,
        nullable=True,
    ...
    sa: Mapped[typing.Optional[str]] = mapped_column(
        "sa",
        String,
        index=False,
        nullable=True,
    ...
    sales_area__name: Mapped[typing.Optional[str]] = mapped_column(
        "sales_area__name",
        String,
        index=False,
        nullable=True,
    ...
    product: Mapped[typing.Optional[str]] = mapped_column(
        "product",
        String,
        index=False,
        nullable=True,
    ...
    product_name: Mapped[typing.Optional[str]] = mapped_column(
        "product_name",
        String,
        index=False,
        nullable=True,
    ...
    uom: Mapped[typing.Optional[str]] = mapped_column(
        "uom",
        String,
        index=False,
        nullable=True,
    ...
    invoice_dt: Mapped[typing.Optional[str]] = mapped_column(
        "invoice_dt",
        String,
        index=False,
        nullable=True,
    ...
    target_qty_kl: Mapped[typing.Optional[float]] = mapped_column(
        "target_qty_kl",
        Numeric,
        index=False,
        nullable=True,
    ...
    target_qty_tmt: Mapped[typing.Optional[float]] = mapped_column(
        "target_qty_tmt",
        Numeric,
        index=False,
        nullable=True,
    ...
    fiscal_year: Mapped[typing.Optional[str]] = mapped_column(
        "fiscal_year",
        String,
        index=False,
        nullable=True,
    ...
    cur_fiscal_year: Mapped[typing.Optional[str]] = mapped_column(
        "cur_fiscal_year",
        String,
        index=False,
        nullable=True,
    ...
    orgsbucd: Mapped[typing.Optional[str]] = mapped_column(
        "orgsbucd",
        String,
        index=False,
        nullable=True,
    ...
    orgsbuname: Mapped[typing.Optional[str]] = mapped_column(
        "orgsbuname",
        String,
        index=False,
        nullable=True,
    ...
    orgzonecd: Mapped[typing.Optional[str]] = mapped_column(
        "orgzonecd",
        String,
        index=False,
        nullable=True,
    ...
    orgzonename: Mapped[typing.Optional[str]] = mapped_column(
        "orgzonename",
        String,
        index=False,
        nullable=True,
    ...
    orgrocd: Mapped[typing.Optional[str]] = mapped_column(
        "orgrocd",
        String,
        index=False,
        nullable=True,
    ...
    orgroname: Mapped[typing.Optional[str]] = mapped_column(
        "orgroname",
        String,
        index=False,
        nullable=True,
    ...
    orgsacd: Mapped[typing.Optional[str]] = mapped_column(
        "orgsacd",
        String,
        index=False,
        nullable=True,
    ...
    orgsaname: Mapped[typing.Optional[str]] = mapped_column(
        "orgsaname",
        String,
        index=False,
        nullable=True,
    ...
    productcode: Mapped[typing.Optional[str]] = mapped_column(
        "productcode",
        String,
        index=False,
        nullable=True,
    ...
    materialgroupname: Mapped[typing.Optional[str]] = mapped_column(
        "materialgroupname",
        String,
        index=False,
        nullable=True,
    ...
    curfiscalyear: Mapped[typing.Optional[str]] = mapped_column(
        "curfiscalyear",
        String,
        index=False,
        nullable=True,
    ...
    fiscalyear: Mapped[typing.Optional[str]] = mapped_column(
        "fiscalyear",
        String,
        index=False,
        nullable=True,
    ...
    yearmonth: Mapped[typing.Optional[str]] = mapped_column(
        "yearmonth",
        String,
        index=False,
        nullable=True,
    ...
    netweight_uom: Mapped[typing.Optional[float]] = mapped_column(
        "netweight_uom",
        Numeric,
        index=False,
        nullable=True,
    ...
    netweight_kg: Mapped[typing.Optional[float]] = mapped_column(
        "netweight_kg",
        Numeric,
        index=False,
        nullable=True,
    ...
    netweight_tmt: Mapped[typing.Optional[float]] = mapped_column(
        "netweight_tmt",
        Numeric,
        index=False,
        nullable=True,
    ...
    total__days__till__present_day: Mapped[typing.Optional[int]] = mapped_column(
        "total__days__till__present_day",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    number__of__sundays__till__present_day: Mapped[typing.Optional[int]] = (
        mapped_column(
            "number__of__sundays__till__present_day",
            Integer,
            index=False,
            nullable=True,
            default=0,
    ...
    target_round: Mapped[typing.Optional[int]] = mapped_column(
        "target_round",
        Integer,
        index=False,
        nullable=True,
    ...
    actual_round: Mapped[typing.Optional[int]] = mapped_column(
        "actual_round",
        Integer,
        index=False,
        nullable=True,
    ...
    final_sum: Mapped[typing.Optional[float]] = mapped_column(
        "final_sum",
        Numeric,
        index=False,
        nullable=True,
    ...
    final_actual_sum: Mapped[typing.Optional[float]] = mapped_column(
        "final_actual_sum",
        Numeric,
        index=False,
        nullable=True,
    ...
    max_pending_days: Mapped[typing.Optional[int]] = mapped_column(
        "max_pending_days",
        Integer,
        index=False,
        nullable=True,
    ...
    working__days__till__present_day__without_sundays: Mapped[typing.Optional[int]] = (
        mapped_column(
            "working__days__till__present_day__without_sundays",
            Integer,
            index=False,
            nullable=True,
            default=0,
    ...
    rate__per__day__required_mmt: Mapped[typing.Optional[float]] = mapped_column(
        "rate__per__day__required_mmt",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    rate_per_day_current_mmt: Mapped[typing.Optional[float]] = mapped_column(
    ...
    total__days_in_fy: Mapped[typing.Optional[int]] = mapped_column(
        "total__days_in_fy",
        Integer,
        index=False,
        nullable=True,
    ...
    pending__days: Mapped[typing.Optional[int]] = mapped_column(
        "pending__days",
        Integer,
        index=False,
        nullable=True,
    ...
    month_year: Mapped[typing.Optional[int]] = mapped_column(
        "month_year",
        Integer,
        index=False,
        nullable=True,
    ...
    month_name: Mapped[typing.Optional[str]] = mapped_column(
        "month_name",
        String,
        index=False,
        nullable=True,
    ...
    fy_month: Mapped[typing.Optional[int]] = mapped_column(
        "fy_month",
        Integer,
        index=False,
        nullable=True,
    ...
    year_monthname: Mapped[typing.Optional[datetime.date]] = mapped_column(
        "year_monthname",
        DATE,
        index=False,
        nullable=True,
    ...
    target__quantity_tmtt: Mapped[typing.Optional[float]] = mapped_column(
        "target__quantity_tmtt",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    prediction__value: Mapped[typing.Optional[float]] = mapped_column(
        "prediction__value",
        Numeric,
        index=False,
        nullable=True,
    ...
    act__tgt__achievement: Mapped[typing.Optional[float]] = mapped_column(
        "act__tgt__achievement",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    zone__region__achievement: Mapped[typing.Optional[float]] = mapped_column(
        "zone__region__achievement",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    product__achievement: Mapped[typing.Optional[float]] = mapped_column(
        "product__achievement",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    engine_id: Mapped[typing.Optional[str]] = mapped_column(
        "engine_id",
        String,
        index=False,
        nullable=True,
...
class M60LevelMetaDataCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    number__of__sundays__till__present_day: typing.Optional[int] = pydantic.Field(
        0, **{}
    )
    ...
    working__days__till__present_day__without_sundays: typing.Optional[int] = (
        pydantic.Field(0, **{})
    )
...
class IndustryPerformanceSchema(UrdhvaPostgresBase):
    ...
    prod1_1: Mapped[typing.Optional[str]] = mapped_column(
        "prod1_1",
        String,
        index=False,
        nullable=True,
    ...
    sbu_name: Mapped[typing.Optional[str]] = mapped_column(
        "sbu_name",
        String,
        index=False,
        nullable=True,
    ...
    statename: Mapped[typing.Optional[str]] = mapped_column(
        "statename",
        String,
        index=False,
        nullable=True,
    ...
    company_name: Mapped[typing.Optional[str]] = mapped_column(
        "company_name",
        String,
        index=False,
        nullable=True,
    ...
    productname: Mapped[typing.Optional[str]] = mapped_column(
        "productname",
        String,
        index=False,
        nullable=True,
    ...
    distname: Mapped[typing.Optional[str]] = mapped_column(
        "distname",
        String,
        index=False,
        nullable=True,
    ...
    prod2: Mapped[typing.Optional[str]] = mapped_column(
        "prod2",
        String,
        index=False,
        nullable=True,
    ...
    comname: Mapped[typing.Optional[str]] = mapped_column(
        "comname",
        String,
        index=False,
        nullable=True,
    ...
    psu_pvt: Mapped[typing.Optional[str]] = mapped_column(
        "psu_pvt",
        String,
        index=False,
        nullable=True,
    ...
    statecode: Mapped[typing.Optional[str]] = mapped_column(
        "statecode",
        String,
        index=False,
        nullable=True,
    ...
    dist: Mapped[typing.Optional[str]] = mapped_column(
        "dist",
        String,
        index=False,
        nullable=True,
    ...
    prod1: Mapped[typing.Optional[str]] = mapped_column(
        "prod1",
        String,
        index=False,
        nullable=True,
    ...
    total: Mapped[typing.Optional[float]] = mapped_column(
        "total",
        Numeric,
        index=False,
        nullable=True,
    ...
    distcode: Mapped[typing.Optional[str]] = mapped_column(
        "distcode",
        String,
        index=False,
        nullable=True,
    ...
    comcode: Mapped[typing.Optional[int]] = mapped_column(
        "comcode",
        Integer,
        index=False,
        nullable=True,
    ...
    code: Mapped[typing.Optional[str]] = mapped_column(
        "code",
        String,
        index=False,
        nullable=True,
    ...
    productcode: Mapped[typing.Optional[int]] = mapped_column(
        "productcode",
        Integer,
        index=False,
        nullable=True,
    ...
    zone_name: Mapped[typing.Optional[str]] = mapped_column(
        "zone_name",
        String,
        index=False,
        nullable=True,
    ...
    region_name: Mapped[typing.Optional[str]] = mapped_column(
        "region_name",
        String,
        index=False,
        nullable=True,
    ...
    newcode: Mapped[typing.Optional[str]] = mapped_column(
        "newcode",
        String,
        index=False,
        nullable=True,
    ...
    coname: Mapped[typing.Optional[str]] = mapped_column(
        "coname",
        String,
        index=False,
        nullable=True,
    ...
    com_type: Mapped[typing.Optional[str]] = mapped_column(
        "com_type",
        String,
        index=False,
        nullable=True,
    ...
    ro: Mapped[typing.Optional[str]] = mapped_column(
        "ro",
        String,
        index=False,
        nullable=True,
...
class Industryperformance_List_Ai_Industry_Performance_QueriesParams(
    pydantic.BaseModel
):
    search_text: str
...
class ConsumerPumpTankDeliverySchema(UrdhvaPostgresBase):
    ...
    depot: Mapped[typing.Optional[str]] = mapped_column(
        "depot",
        String,
        index=False,
        nullable=True,
    ...
    tank_group: Mapped[typing.Optional[str]] = mapped_column(
        "tank_group",
        String,
        index=False,
        nullable=True,
    ...
    tank_no: Mapped[typing.Optional[int]] = mapped_column(
        "tank_no",
        Integer,
        index=False,
        nullable=True,
    ...
    tc_volume: Mapped[typing.Optional[float]] = mapped_column(
        "tc_volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    start_volume: Mapped[typing.Optional[float]] = mapped_column(
        "start_volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    start_water: Mapped[typing.Optional[float]] = mapped_column(
        "start_water",
        Numeric,
        index=False,
        nullable=True,
    ...
    start_temp: Mapped[typing.Optional[float]] = mapped_column(
        "start_temp",
        Numeric,
        index=False,
        nullable=True,
    ...
    start_product_height: Mapped[typing.Optional[float]] = mapped_column(
    ...
    end_volume: Mapped[typing.Optional[float]] = mapped_column(
        "end_volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    end_water: Mapped[typing.Optional[float]] = mapped_column(
        "end_water",
        Numeric,
        index=False,
        nullable=True,
    ...
    end_temp: Mapped[typing.Optional[float]] = mapped_column(
        "end_temp",
        Numeric,
        index=False,
        nullable=True,
    ...
    end_product_height: Mapped[typing.Optional[float]] = mapped_column(
        "end_product_height",
        Numeric,
        index=False,
        nullable=True,
    ...
    manual: Mapped[typing.Optional[bool]] = mapped_column(
        "manual",
        Boolean,
        index=False,
        nullable=True,
    ...
    delivery_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "delivery_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    truck_reg_no: Mapped[typing.Optional[str]] = mapped_column(
        "truck_reg_no",
        String,
        index=False,
        nullable=True,
    ...
    po_number: Mapped[typing.Optional[str]] = mapped_column(
        "po_number",
        String,
        index=False,
        nullable=True,
    ...
    verification_delivery_time: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
            "verification_delivery_time",
            DateTime(timezone=True),
            index=False,
            nullable=True,
            default=None,
    ...
    verification_sales_order_no: Mapped[typing.Optional[str]] = mapped_column(
        "verification_sales_order_no",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    actual_volume: Mapped[typing.Optional[float]] = mapped_column(
        "actual_volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    actual_temp: Mapped[typing.Optional[float]] = mapped_column(
        "actual_temp",
        Numeric,
        index=False,
        nullable=True,
    ...
    density: Mapped[typing.Optional[float]] = mapped_column(
        "density",
        Numeric,
        index=False,
        nullable=True,
    ...
    pre_density: Mapped[typing.Optional[float]] = mapped_column(
        "pre_density",
        Numeric,
        index=False,
        nullable=True,
    ...
    post_density: Mapped[typing.Optional[float]] = mapped_column(
        "post_density",
        Numeric,
        index=False,
        nullable=True,
    ...
    source: Mapped[typing.Optional[str]] = mapped_column(
        "source",
        String,
        index=False,
        nullable=True,
...
class ConsumerPumpTankDeliveryCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    manual: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class ConsumperPumpTransactionSchema(UrdhvaPostgresBase):
    ...
    make: Mapped[typing.Optional[str]] = mapped_column(
        "make",
        String,
        index=False,
        nullable=True,
    ...
    model: Mapped[typing.Optional[str]] = mapped_column(
        "model",
        String,
        index=False,
        nullable=True,
    ...
    make_model: Mapped[typing.Optional[str]] = mapped_column(
        "make_model",
        String,
        index=False,
        nullable=True,
    ...
    capacity: Mapped[typing.Optional[int]] = mapped_column(
        "capacity",
        Integer,
        index=False,
        nullable=True,
    ...
    token_type: Mapped[typing.Optional[str]] = mapped_column(
        "token_type",
        String,
        index=False,
        nullable=True,
    ...
    transaction_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "transaction_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    transaction_type: Mapped[typing.Optional[str]] = mapped_column(
        "transaction_type",
        String,
        index=False,
        nullable=True,
    ...
    start_pump_totalizer: Mapped[typing.Optional[float]] = mapped_column(
        "start_pump_totalizer",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    end_pump_totalizer: Mapped[typing.Optional[float]] = mapped_column(
        "end_pump_totalizer",
        Numeric,
        index=False,
        nullable=True,
    ...
    consumption_type: Mapped[typing.Optional[str]] = mapped_column(
        "consumption_type",
        String,
        index=False,
        nullable=True,
    ...
    consumption_benchmark: Mapped[typing.Optional[int]] = mapped_column(
    ...
    dispensing_unit: Mapped[typing.Optional[int]] = mapped_column(
        "dispensing_unit",
        Integer,
        index=False,
        nullable=True,
    ...
    department: Mapped[typing.Optional[str]] = mapped_column(
        "department",
        String,
        index=False,
        nullable=True,
...
class LpgSubsidyExceptionDataSchema(UrdhvaPostgresBase):
    ...
    exception__code: Mapped[str] = mapped_column(
        "exception__code",
        String,
        index=False,
        nullable=False,
    ...
    distributor__code: Mapped[int] = mapped_column(
        "distributor__code",
        Integer,
        index=False,
        nullable=False,
    ...
    refills: Mapped[int] = mapped_column(
        "refills",
        Integer,
        index=False,
        nullable=False,
    ...
    consumers: Mapped[int] = mapped_column(
        "consumers",
        Integer,
        index=False,
        nullable=False,
    ...
    exception_description: Mapped[str] = mapped_column(
    ...
    exception_name: Mapped[str] = mapped_column(
        "exception_name",
        String,
        index=False,
        nullable=False,
    ...
    sa_code: Mapped[str] = mapped_column(
        "sa_code",
        String,
        index=False,
        nullable=False,
    ...
    ro_code: Mapped[str] = mapped_column(
        "ro_code",
        String,
        index=False,
        nullable=False,
...
class LpgSubsidyFailureDataSchema(UrdhvaPostgresBase):
    ...
    payment_error_code: Mapped[str] = mapped_column(
        "payment_error_code",
        String,
        index=False,
        nullable=False,
    ...
    payment_error_decription: Mapped[str] = mapped_column(
        "payment_error_decription",
        String,
        index=False,
        nullable=False,
        default=None,
    ...
    payment_error_name: Mapped[str] = mapped_column(
        "payment_error_name",
        String,
        index=False,
        nullable=False,
...
class ConsumerPumpTransactionsSchema(UrdhvaPostgresBase):
    ...
    unique_txn_id: Mapped[int] = mapped_column(
        "unique_txn_id",
        Integer,
        index=False,
        nullable=False,
    ...
    txn_id: Mapped[typing.Optional[str]] = mapped_column(
        "txn_id",
        String,
        index=False,
        nullable=True,
    ...
    txn_type: Mapped[typing.Optional[str]] = mapped_column(
        "txn_type",
        String,
        index=False,
        nullable=True,
    ...
    txn_start_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "txn_start_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    txn_end_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "txn_end_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    quantity: Mapped[typing.Optional[float]] = mapped_column(
        "quantity",
        Numeric,
        index=False,
        nullable=True,
    ...
    amount: Mapped[typing.Optional[float]] = mapped_column(
        "amount",
        Numeric,
        index=False,
        nullable=True,
    ...
    fuel_equip_type: Mapped[typing.Optional[str]] = mapped_column(
        "fuel_equip_type",
        String,
        index=False,
        nullable=True,
    ...
    vehicle_no: Mapped[typing.Optional[str]] = mapped_column(
        "vehicle_no",
        String,
        index=False,
        nullable=True,
    ...
    product_id: Mapped[typing.Optional[str]] = mapped_column(
        "product_id",
        String,
        index=False,
        nullable=True,
    ...
    pump_no: Mapped[typing.Optional[str]] = mapped_column(
        "pump_no",
        String,
        index=False,
        nullable=True,
    ...
    nozzle_id: Mapped[typing.Optional[str]] = mapped_column(
        "nozzle_id",
        String,
        index=False,
        nullable=True,
    ...
    global_nozzle_id: Mapped[typing.Optional[str]] = mapped_column(
        "global_nozzle_id",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            unique_txn_id, name="consumer_pump_transactions_unique_txn_id"
        ),
    )
...
class ConsumerPumpTankInventorySchema(UrdhvaPostgresBase):
    ...
    inventory_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "inventory_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    tank_id: Mapped[typing.Optional[str]] = mapped_column(
        "tank_id",
        String,
        index=False,
        nullable=True,
    ...
    stock_txn_code: Mapped[typing.Optional[str]] = mapped_column(
        "stock_txn_code",
        String,
        index=False,
        nullable=True,
    ...
    stock_txn_id: Mapped[typing.Optional[str]] = mapped_column(
        "stock_txn_id",
        String,
        index=False,
        nullable=True,
    ...
    prod_gross_qty: Mapped[typing.Optional[float]] = mapped_column(
        "prod_gross_qty",
        Numeric,
        index=False,
        nullable=True,
    ...
    tank_capacity: Mapped[typing.Optional[float]] = mapped_column(
        "tank_capacity",
        Numeric,
        index=False,
        nullable=True,
    ...
    product_volume: Mapped[typing.Optional[float]] = mapped_column(
        "product_volume",
        Numeric,
        index=False,
        nullable=True,
    ...
    product_level: Mapped[typing.Optional[float]] = mapped_column(
        "product_level",
        Numeric,
        index=False,
        nullable=True,
    ...
    density_at_15: Mapped[typing.Optional[float]] = mapped_column(
        "density_at_15",
        Numeric,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            unique_txn_id, name="consumer_pump_tank_inventory_unique_txn_id"
        ),
    )
...
class ConsumerPumpStocksReceiptsSchema(UrdhvaPostgresBase):
    ...
    unique_txn_id: Mapped[str] = mapped_column(
        "unique_txn_id",
        String,
        index=False,
        nullable=False,
    ...
    stock_receipt_id: Mapped[typing.Optional[str]] = mapped_column(
        "stock_receipt_id",
        String,
        index=False,
        nullable=True,
    ...
    prod_qty_start: Mapped[typing.Optional[float]] = mapped_column(
        "prod_qty_start",
        Numeric,
        index=False,
        nullable=True,
    ...
    prod_qty_end: Mapped[typing.Optional[float]] = mapped_column(
        "prod_qty_end",
        Numeric,
        index=False,
        nullable=True,
    ...
    decantation_start_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "decantation_start_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    decantation_end_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "decantation_end_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    __table_args__ = (
        UniqueConstraint(
            unique_txn_id, name="consumer_pump_stocks_receipts_unique_txn_id"
        ),
    )
...
class Consumerpumpstocksreceipts_Bulk_Update_Cp_Stock_ReceiptsParams(
    pydantic.BaseModel
):
    pass
...
class HostSickTtsSchema(UrdhvaPostgresBase):
    ...
    load_number: Mapped[typing.Optional[int]] = mapped_column(
        "load_number",
        Integer,
        index=False,
        nullable=True,
    ...
    truck_number: Mapped[typing.Optional[str]] = mapped_column(
        "truck_number",
        String,
        index=False,
        nullable=True,
    ...
    created_date: Mapped[typing.Optional[datetime.date]] = mapped_column(
        "created_date",
        DATE,
        index=False,
        nullable=True,
    ...
    customer_name: Mapped[typing.Optional[str]] = mapped_column(
        "customer_name",
        String,
        index=False,
        nullable=True,
    ...
    compartment_number: Mapped[typing.Optional[int]] = mapped_column(
        "compartment_number",
        Integer,
        index=False,
        nullable=True,
    ...
    required_qty: Mapped[typing.Optional[int]] = mapped_column(
        "required_qty",
        Integer,
        index=False,
        nullable=True,
    ...
    loaded_qty: Mapped[typing.Optional[int]] = mapped_column(
        "loaded_qty",
        Integer,
        index=False,
        nullable=True,
    ...
    sick_declared_by: Mapped[typing.Optional[str]] = mapped_column(
        "sick_declared_by",
        String,
        index=False,
        nullable=True,
    ...
    sick_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "sick_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    bcu_number: Mapped[typing.Optional[str]] = mapped_column(
        "bcu_number",
        String,
        index=False,
        nullable=True,
    ...
    bay_number: Mapped[typing.Optional[str]] = mapped_column(
        "bay_number",
        String,
        index=False,
        nullable=True,
    ...
    alert_created: Mapped[typing.Optional[bool]] = mapped_column(
        "alert_created",
        Boolean,
        index=False,
        nullable=True,
    ...
    date: Mapped[typing.Optional[datetime.date]] = mapped_column(
        "date",
        DATE,
        index=False,
        nullable=True,
    ...
    date_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "date_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            bay_number,
            date,
            name="host_sick_tts_loadn_truck_custo_compa_produ_sapid_bcunu_baynu_",
        ),
    )
...
class HostSickTtsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    alert_created: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class HostCancelledTtsSchema(UrdhvaPostgresBase):
    ...
    created_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "created_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    cancelled_by: Mapped[typing.Optional[str]] = mapped_column(
        "cancelled_by",
        String,
        index=False,
        nullable=True,
    ...
    cancelled_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "cancelled_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    entry_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "entry_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    exit_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "exit_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            compartment_number,
            date,
            name="host_cancelled_tts_loadn_truck_custo_produ_sapid_compa_date",
        ),
    )
...
class HostKFactorChangesSchema(UrdhvaPostgresBase):
    ...
    preset_number: Mapped[typing.Optional[str]] = mapped_column(
        "preset_number",
        String,
        index=False,
        nullable=True,
    ...
    timestamp: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "timestamp",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    bcu_parameter: Mapped[typing.Optional[str]] = mapped_column(
        "bcu_parameter",
        String,
        index=False,
        nullable=True,
    ...
    initial_setting: Mapped[typing.Optional[str]] = mapped_column(
        "initial_setting",
        String,
        index=False,
        nullable=True,
    ...
    final_setting: Mapped[typing.Optional[str]] = mapped_column(
        "final_setting",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_k_factor_changes_bcunu_prese_times_initi_final_sapid_date",
        ),
    )
...
class HostLocalLoadedTtsSchema(UrdhvaPostgresBase):
    ...
    recipe_name: Mapped[typing.Optional[str]] = mapped_column(
        "recipe_name",
        String,
        index=False,
        nullable=True,
    ...
    card_number: Mapped[typing.Optional[str]] = mapped_column(
        "card_number",
        String,
        index=False,
        nullable=True,
    ...
    start_totalizer: Mapped[typing.Optional[float]] = mapped_column(
        "start_totalizer",
        Numeric,
        index=False,
        nullable=True,
    ...
    end_totalizer: Mapped[typing.Optional[float]] = mapped_column(
        "end_totalizer",
        Numeric,
        index=False,
        nullable=True,
    ...
    transaction_end_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            compartment_number,
            date,
            name="host_local_loaded_tts_bcunu_recip_truck_cardn_start_endto_load",
        ),
    )
...
class HostBayReAssignmentSchema(UrdhvaPostgresBase):
    ...
    fan_number: Mapped[typing.Optional[str]] = mapped_column(
        "fan_number",
        String,
        index=False,
        nullable=True,
    ...
    reassigned_bay: Mapped[typing.Optional[str]] = mapped_column(
        "reassigned_bay",
        String,
        index=False,
        nullable=True,
    ...
    bay_reassignment_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "bay_reassignment_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    assigned_bay: Mapped[typing.Optional[str]] = mapped_column(
        "assigned_bay",
        String,
        index=False,
        nullable=True,
    ...
    reassign_loaded_qty: Mapped[typing.Optional[int]] = mapped_column(
        "reassign_loaded_qty",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            reassign_loaded_qty,
            date,
            name="host_bay_re_assignment_loadn_truck_custo_compa_produ_requi_loa",
        ),
    )
...
class HostManualFanPrintedSchema(UrdhvaPostgresBase):
    ...
    manual_fan_count: Mapped[typing.Optional[int]] = mapped_column(
        "manual_fan_count",
        Integer,
        index=False,
        nullable=True,
    ...
    auto_fan_count: Mapped[typing.Optional[int]] = mapped_column(
        "auto_fan_count",
        Integer,
        index=False,
        nullable=True,
    ...
    total_count: Mapped[typing.Optional[int]] = mapped_column(
        "total_count",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            date,
            sap_id,
            name="host_manual_fan_printed_auto_fan_count_total_count_date_sap_id",
        ),
    )
...
class HostUnauthorisedFlowSchema(UrdhvaPostgresBase):
    ...
    meter_number: Mapped[typing.Optional[int]] = mapped_column(
        "meter_number",
        Integer,
        index=False,
        nullable=True,
    ...
    net_totalizer: Mapped[typing.Optional[float]] = mapped_column(
        "net_totalizer",
        Numeric,
        index=False,
        nullable=True,
    ...
    nettotalizer: Mapped[typing.Optional[float]] = mapped_column(
        "nettotalizer",
        Numeric,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_unauthorised_flow_bcunu_meter_times_start_endto_netto_sap",
        ),
    )
...
class HostOverLoadedTtsSchema(UrdhvaPostgresBase):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            bay_number,
            date,
            name="host_over_loaded_tts_loadn_truck_compa_produ_requi_loade_sapid",
        ),
    )
...
class HostMFMFactorSchema(UrdhvaPostgresBase):
    ...
    mfm_number: Mapped[typing.Optional[str]] = mapped_column(
        "mfm_number",
        String,
        index=False,
        nullable=True,
    ...
    mfm_description: Mapped[typing.Optional[str]] = mapped_column(
        "mfm_description",
        String,
        index=False,
        nullable=True,
    ...
    stock_code: Mapped[typing.Optional[str]] = mapped_column(
        "stock_code",
        String,
        index=False,
        nullable=True,
    ...
    current_k_factor: Mapped[typing.Optional[float]] = mapped_column(
        "current_k_factor",
        Numeric,
        index=False,
        nullable=True,
    ...
    last_k_factor: Mapped[typing.Optional[str]] = mapped_column(
        "last_k_factor",
        String,
        index=False,
        nullable=True,
    ...
    last_k_factor_change_date: Mapped[typing.Optional[str]] = mapped_column(
    ...
    current_meter_factor: Mapped[typing.Optional[float]] = mapped_column(
    ...
    last_meter_factor: Mapped[typing.Optional[float]] = mapped_column(
        "last_meter_factor",
        Numeric,
        index=False,
        nullable=True,
    ...
    last_meter_factor_change_date: Mapped[typing.Optional[str]] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            last_meter_factor_change_date,
            sap_id,
            name="host_mfm_factor_mfmnu_stock_lastk_lastm_sapid",
        ),
    )
...
class MasterStatusSchema(UrdhvaPostgresBase):
    ...
    location_code: Mapped[typing.Optional[str]] = mapped_column(
        "location_code",
        String,
        index=False,
        nullable=True,
    ...
    active_server_name: Mapped[str] = mapped_column(
        "active_server_name",
        String,
        index=False,
        nullable=False,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="master_status_statu_locat_activ_sapid_date",
        ),
    )
...
class HostStandaloneTtsSchema(UrdhvaPostgresBase):
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_standalone_tts_loadn_truck_compa_bcunu_baynu_produ_requi_",
        ),
    )
...
class HostTasUserDetailsSchema(UrdhvaPostgresBase):
    ...
    password_expiry_date: Mapped[typing.Optional[str]] = mapped_column(
    ...
    user_group: Mapped[typing.Optional[str]] = mapped_column(
        "user_group",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_tas_user_details_usern_passw_userg_sapid_date",
        ),
    )
...
class HostLiveTankDetailsSchema(UrdhvaPostgresBase):
    ...
    tank_mode: Mapped[typing.Optional[str]] = mapped_column(
        "tank_mode",
        String,
        index=False,
        nullable=True,
    ...
    tank_code: Mapped[typing.Optional[str]] = mapped_column(
        "tank_code",
        String,
        index=False,
        nullable=True,
    ...
    curr_level: Mapped[typing.Optional[int]] = mapped_column(
        "curr_level",
        Integer,
        index=False,
        nullable=True,
    ...
    water_level: Mapped[typing.Optional[int]] = mapped_column(
        "water_level",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_live_tank_details_tank_name_tank_mode_sap_id_date",
        ),
    )
...
class HostSuspectedLoadsSchema(UrdhvaPostgresBase):
    ...
    event_time: Mapped[typing.Optional[str]] = mapped_column(
        "event_time",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_suspected_loads_event_baynu_bcunu_loadn_truck_sapid_date",
        ),
    )
...
class HostPltDetailsSchema(UrdhvaPostgresBase):
    ...
    transaction_number: Mapped[typing.Optional[int]] = mapped_column(
        "transaction_number",
        Integer,
        index=False,
        nullable=True,
    ...
    stock: Mapped[typing.Optional[str]] = mapped_column(
        "stock",
        String,
        index=False,
        nullable=True,
    ...
    trans_start_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "trans_start_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    trans_end_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "trans_end_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    cum_start_gross_vol_kl: Mapped[typing.Optional[int]] = mapped_column(
        "cum_start_gross_vol_kl",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    cum_end_gross_vol_kl: Mapped[typing.Optional[int]] = mapped_column(
        "cum_end_gross_vol_kl",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    cum_start_mass_mt: Mapped[typing.Optional[str]] = mapped_column(
        "cum_start_mass_mt",
        String,
        index=False,
        nullable=True,
    ...
    cum_end_mass_mt: Mapped[typing.Optional[str]] = mapped_column(
        "cum_end_mass_mt",
        String,
        index=False,
        nullable=True,
    ...
    uncorr_vol_kl: Mapped[typing.Optional[int]] = mapped_column(
        "uncorr_vol_kl",
        Integer,
        index=False,
        nullable=True,
    ...
    mass_mt: Mapped[typing.Optional[int]] = mapped_column(
        "mass_mt",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_plt_details_trans_mfmnu_stock_sapid_date",
        ),
    )
...
class HostDayEndDetailsSchema(UrdhvaPostgresBase):
    ...
    bcu_start_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "bcu_start_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    bcu_end_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "bcu_end_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    bcu_net_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "bcu_net_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    mfm_start_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "mfm_start_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    mfm_end_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "mfm_end_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    mfm_net_totalizer: Mapped[typing.Optional[int]] = mapped_column(
        "mfm_net_totalizer",
        Integer,
        index=False,
        nullable=True,
    ...
    invoiced_qty: Mapped[typing.Optional[int]] = mapped_column(
        "invoiced_qty",
        Integer,
        index=False,
        nullable=True,
    ...
    total_tl_qty_loaded: Mapped[typing.Optional[int]] = mapped_column(
        "total_tl_qty_loaded",
        Integer,
        index=False,
        nullable=True,
    ...
    bcu_mfm_net_totalizer_diff: Mapped[typing.Optional[int]] = mapped_column(
    ...
    invoiced_total_tl_qty_diff: Mapped[typing.Optional[int]] = mapped_column(
    ...
    invoiced_bcu_net_qty_diff: Mapped[typing.Optional[int]] = mapped_column(
    ...
    topup_qty_local_mode: Mapped[typing.Optional[int]] = mapped_column(
    ...
    sampling_qty: Mapped[typing.Optional[int]] = mapped_column(
        "sampling_qty",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_day_end_details_bay_number_bcu_number_stock_sap_id_date",
        ),
    )
...
class HostDayEndSummarySchema(UrdhvaPostgresBase):
    ...
    total_loaded_tts: Mapped[typing.Optional[int]] = mapped_column(
        "total_loaded_tts",
        Integer,
        index=False,
        nullable=True,
    ...
    total_sick_tts: Mapped[typing.Optional[int]] = mapped_column(
        "total_sick_tts",
        Integer,
        index=False,
        nullable=True,
    ...
    total_cancelled_tts: Mapped[int] = mapped_column(
        "total_cancelled_tts",
        Integer,
        index=False,
        nullable=False,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            sap_id,
            date,
            name="host_day_end_summary_total_total_total_sapid_date",
        ),
    )
...
class TagsDataSchema(UrdhvaPostgresBase):
    ...
    count: Mapped[typing.Optional[str]] = mapped_column(
        "count",
        String,
        index=False,
        nullable=True,
    ...
    device_count: Mapped[typing.Optional[str]] = mapped_column(
        "device_count",
        String,
        index=False,
        nullable=True,
    ...
    system: Mapped[typing.Optional[str]] = mapped_column(
        "system",
        String,
        index=False,
        nullable=True,
    ...
    mf_count: Mapped[typing.Optional[str]] = mapped_column(
        "mf_count",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            zone,
            system,
            name="tags_data_sap_id_name_device_type_zone_system",
        ),
    )
...
class TasProofTestSchema(UrdhvaPostgresBase):
    ...
    proof_test_created_at: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "proof_test_created_at",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    next_proof_test_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint(sap_id, device_id, name="tas_proof_test_sap_id_device_id"),
    )
...
class ArchitectureDataSchema(UrdhvaPostgresBase):
    ...
    total_tank_count: Mapped[typing.Optional[int]] = mapped_column(
        "total_tank_count",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            device_type,
            total_tank_count,
            name="architecture_data_sap_id_name_device_type_total_tank_count",
        ),
    )
...
class PerformanceIndexSchema(UrdhvaPostgresBase):
    ...
    is_plant: Mapped[typing.Optional[bool]] = mapped_column(
        "is_plant",
        Boolean,
        index=False,
        nullable=True,
...
class PerformanceIndexCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    name: str
    score: float
    is_plant: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class PerformanceScoreSchema(UrdhvaPostgresBase):
    ...
    national_score: Mapped[float] = mapped_column(
        "national_score",
        Numeric,
        index=False,
        nullable=False,
    ...
    category: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "category",
        JSONB,
        index=False,
        nullable=True,
    ...
    insights: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "insights",
        JSONB,
        index=False,
        nullable=True,
...
class PerformanceScoreHistorySchema(UrdhvaPostgresBase):
    ...
    __table_args__ = (
        UniqueConstraint(
            sap_id, timestamp, name="performance_score_history_sap_id_timestamp"
        ),
    )
...
class CrisAlertHistorySchema(UrdhvaPostgresBase):
    ...
    vendor_name: Mapped[typing.Optional[str]] = mapped_column(
        "vendor_name",
        String,
        index=False,
        nullable=True,
    ...
    interlock_type: Mapped[typing.Optional[str]] = mapped_column(
        "interlock_type",
        String,
        index=False,
        nullable=True,
    ...
    interlock_description: Mapped[typing.Optional[str]] = mapped_column(
    ...
    severity: Mapped[typing.Optional[str]] = mapped_column(
        "severity",
        String,
        index=False,
        nullable=True,
    ...
    occurrence_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "occurrence_date",
        DateTime(timezone=False),
        index=False,
        nullable=True,
    ...
    closure_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "closure_date",
        DateTime(timezone=False),
        index=False,
        nullable=True,
    ...
    products: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "products",
        JSONB,
        index=False,
        nullable=True,
...
class DryOutAlertReportSchema(UrdhvaPostgresBase):
    ...
    tank_capacity: Mapped[typing.Optional[str]] = mapped_column(
        "tank_capacity",
        String,
        index=False,
        nullable=True,
    ...
    avgsales_daily: Mapped[typing.Optional[float]] = mapped_column(
        "avgsales_daily",
        Numeric,
        index=False,
        nullable=True,
    ...
    dryout_start_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "dryout_start_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    dryout_end_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "dryout_end_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    dryout_date: Mapped[datetime.datetime] = mapped_column(
        "dryout_date",
        DateTime(timezone=True),
        index=True,
        nullable=False,
    ...
    alert_status: Mapped[typing.Optional[str]] = mapped_column(
        "alert_status",
        String,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            product_code,
            dryout_date,
            name="dry_out_alert_report_sap_id_product_code_dryout_date",
        ),
    )
...
class VendorApiAuditSchema(UrdhvaPostgresBase):
    ...
    payload: Mapped[typing.Optional[dict]] = mapped_column(
        "payload",
        JSONB,
        index=False,
        nullable=True,
    ...
    request_no: Mapped[typing.Optional[str]] = mapped_column(
        "request_no",
        String,
        index=True,
        nullable=True,
    ...
    response_msg: Mapped[typing.Optional[str]] = mapped_column(
        "response_msg",
        String,
        index=False,
        nullable=True,
    ...
    request_datetime: Mapped[datetime.datetime] = mapped_column(
        "request_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    api_ack: Mapped[typing.Optional[str]] = mapped_column(
        "api_ack",
        String,
        index=False,
        nullable=True,
    ...
    api_ack_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "api_ack_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
...
class VtsTruckDetailsSchema(UrdhvaPostgresBase):
    ...
    truck_regno: Mapped[str] = mapped_column(
        "truck_regno",
        String,
        index=True,
        nullable=False,
    ...
    truck_status: Mapped[typing.Optional[str]] = mapped_column(
        "truck_status",
        String,
        index=False,
        nullable=True,
    ...
    block_start_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
    ...
    block_end_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "block_end_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    instance_1: Mapped[typing.Optional[int]] = mapped_column(
        "instance_1",
        Integer,
        index=False,
        nullable=True,
    ...
    instance_2: Mapped[typing.Optional[int]] = mapped_column(
        "instance_2",
        Integer,
        index=False,
        nullable=True,
    ...
    instance_3: Mapped[typing.Optional[int]] = mapped_column(
        "instance_3",
        Integer,
        index=False,
        nullable=True,
    ...
    blacklist: Mapped[typing.Optional[bool]] = mapped_column(
        "blacklist",
        Boolean,
        index=False,
        nullable=True,
    ...
    truck_history: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "truck_history",
        JSONB,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(truck_regno, name="vts_truck_details_truck_regno"),
    )
...
class VtsTruckDetailsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    alert_id: typing.Optional[str] = pydantic.Field("", **{})
    blacklist: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class DryOutRoLossSchema(UrdhvaPostgresBase):
    ...
    loss_month: Mapped[typing.Optional[str]] = mapped_column(
        "loss_month",
        String,
        index=True,
        nullable=True,
    ...
    estimated_loss: Mapped[typing.Optional[float]] = mapped_column(
        "estimated_loss",
        Numeric,
        index=False,
        nullable=True,
    ...
    estimated_loss_amount: Mapped[typing.Optional[float]] = mapped_column(
    ...
    dryout_days: Mapped[typing.Optional[str]] = mapped_column(
        "dryout_days",
        String,
        index=False,
        nullable=True,
    ...
    avg_daily_sales: Mapped[typing.Optional[float]] = mapped_column(
        "avg_daily_sales",
        Numeric,
        index=False,
        nullable=True,
    ...
    avg_daily_sales_amount: Mapped[typing.Optional[float]] = mapped_column(
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            product_name,
            loss_month,
            name="dry_out_ro_loss_zone_tank_no_sap_id_product_name_loss_month",
        ),
    )
...
class RoMasterDataSchema(UrdhvaPostgresBase):
    ...
    interlock: Mapped[str] = mapped_column(
        "interlock",
        String,
        index=False,
        nullable=False,
    ...
    monthly_quota: Mapped[str] = mapped_column(
        "monthly_quota",
        String,
        index=False,
        nullable=False,
    ...
    sales_officer_quota: Mapped[int] = mapped_column(
        "sales_officer_quota",
        Integer,
        index=False,
        nullable=False,
    ...
    sales_officer_instance: Mapped[int] = mapped_column(
    ...
    regional_manager_quota: Mapped[int] = mapped_column(
    ...
    regional_manager_instance: Mapped[int] = mapped_column(
    ...
    zonal_head_quota: Mapped[int] = mapped_column(
        "zonal_head_quota",
        Integer,
        index=False,
        nullable=False,
    ...
    zonal_head_instance: Mapped[int] = mapped_column(
        "zonal_head_instance",
        Integer,
        index=False,
        nullable=False,
...
class TASMonthlyOIScoresSchema(UrdhvaPostgresBase):
    ...
    module_name: Mapped[typing.Optional[str]] = mapped_column(
        "module_name",
        String,
        index=False,
        nullable=True,
    ...
    rule_name: Mapped[typing.Optional[str]] = mapped_column(
        "rule_name",
        String,
        index=False,
        nullable=True,
    ...
    year: Mapped[typing.Optional[int]] = mapped_column(
        "year",
        Integer,
        index=False,
        nullable=True,
    ...
    month: Mapped[typing.Optional[int]] = mapped_column(
        "month",
        Integer,
        index=False,
        nullable=True,
    ...
    score: Mapped[typing.Optional[float]] = mapped_column(
        "score",
        Numeric,
        index=False,
        nullable=True,
    ...
    weightage: Mapped[typing.Optional[float]] = mapped_column(
        "weightage",
        Numeric,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            year,
            month,
            name="tas_monthly_oi_scores_locat_modul_rulen_year_month",
        ),
    )
...
class SodInfraSchema(UrdhvaPostgresBase):
    ...
    company: Mapped[typing.Optional[str]] = mapped_column(
        "company",
        String,
        index=False,
        nullable=True,
    ...
    type: Mapped[typing.Optional[str]] = mapped_column(
        "type",
        String,
        index=False,
        nullable=True,
    ...
    region_ppac: Mapped[typing.Optional[str]] = mapped_column(
        "region_ppac",
        String,
        index=False,
        nullable=True,
    ...
    ms: Mapped[typing.Optional[int]] = mapped_column(
        "ms",
        Integer,
        index=False,
        nullable=True,
    ...
    sko: Mapped[typing.Optional[int]] = mapped_column(
        "sko",
        Integer,
        index=False,
        nullable=True,
    ...
    hsd: Mapped[typing.Optional[int]] = mapped_column(
        "hsd",
        Integer,
        index=False,
        nullable=True,
    ...
    total: Mapped[typing.Optional[int]] = mapped_column(
        "total",
        Integer,
        index=False,
        nullable=True,
    ...
    mode_of_receipt: Mapped[typing.Optional[str]] = mapped_column(
        "mode_of_receipt",
        String,
        index=False,
        nullable=True,
    ...
    latitude: Mapped[typing.Optional[float]] = mapped_column(
        "latitude",
        Numeric,
        index=False,
        nullable=True,
    ...
    longitude: Mapped[typing.Optional[float]] = mapped_column(
        "longitude",
        Numeric,
        index=False,
        nullable=True,
    ...
    filename: Mapped[typing.Optional[str]] = mapped_column(
        "filename",
        String,
        index=False,
        nullable=True,
...
class LPGInfraSchema(UrdhvaPostgresBase):
    ...
    installed_bottling_capacity: Mapped[typing.Optional[float]] = mapped_column(
        "installed_bottling_capacity",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    operating_bottling_capacity: Mapped[typing.Optional[float]] = mapped_column(
        "operating_bottling_capacity",
        Numeric,
        index=False,
        nullable=True,
        default=0.0,
    ...
    ccoe_tankage: Mapped[typing.Optional[float]] = mapped_column(
        "ccoe_tankage",
        Numeric,
        index=False,
        nullable=True,
    ...
    time_of_commissioning: Mapped[typing.Optional[str]] = mapped_column(
    ...
    mode: Mapped[typing.Optional[str]] = mapped_column(
        "mode",
        String,
        index=False,
        nullable=True,
    ...
    supply: Mapped[typing.Optional[str]] = mapped_column(
        "supply",
        String,
        index=False,
        nullable=True,
...
class AVIATIONInfraSchema(UrdhvaPostgresBase):
    ...
    operation_status: Mapped[typing.Optional[str]] = mapped_column(
        "operation_status",
        String,
        index=False,
        nullable=True,
    ...
    tankage: Mapped[typing.Optional[float]] = mapped_column(
        "tankage",
        Numeric,
        index=False,
        nullable=True,
...
class LUBESInfraSchema(UrdhvaPostgresBase):
    ...
    base_oil_tankages: Mapped[typing.Optional[float]] = mapped_column(
        "base_oil_tankages",
        Numeric,
        index=False,
        nullable=True,
    ...
    landline: Mapped[typing.Optional[str]] = mapped_column(
        "landline",
        String,
        index=False,
        nullable=True,
...
class PlantRoInfraSchema(UrdhvaPostgresBase):
    ...
    ro_status: Mapped[typing.Optional[str]] = mapped_column(
        "ro_status",
        String,
        index=False,
        nullable=True,
    ...
    retail_outlet: Mapped[typing.Optional[float]] = mapped_column(
        "retail_outlet",
        Numeric,
        index=False,
        nullable=True,
    ...
    ros_commissioned: Mapped[typing.Optional[float]] = mapped_column(
        "ros_commissioned",
        Numeric,
        index=False,
        nullable=True,
    ...
    ros_decommissioned: Mapped[typing.Optional[float]] = mapped_column(
        "ros_decommissioned",
        Numeric,
        index=False,
        nullable=True,
    ...
    start_date: Mapped[typing.Optional[str]] = mapped_column(
        "start_date",
        String,
        index=False,
        nullable=True,
    ...
    to_date: Mapped[typing.Optional[str]] = mapped_column(
        "to_date",
        String,
        index=False,
        nullable=True,
...
class PlantCngInfraSchema(UrdhvaPostgresBase):
    ...
    cng_outlet: Mapped[typing.Optional[float]] = mapped_column(
        "cng_outlet",
        Numeric,
        index=False,
        nullable=True,
...
class PlantEvInfraSchema(UrdhvaPostgresBase):
    ...
    ro_name: Mapped[typing.Optional[str]] = mapped_column(
        "ro_name",
        String,
        index=False,
        nullable=True,
    ...
    battery_swapping_stations: Mapped[typing.Optional[float]] = mapped_column(
    ...
    vehicle_charging_stations: Mapped[typing.Optional[float]] = mapped_column(
    ...
    fame_status: Mapped[typing.Optional[str]] = mapped_column(
        "fame_status",
        String,
        index=False,
        nullable=True,
    ...
    non_fame_status: Mapped[typing.Optional[str]] = mapped_column(
        "non_fame_status",
        String,
        index=False,
        nullable=True,
    ...
    date: Mapped[typing.Optional[str]] = mapped_column(
        "date",
        String,
        index=False,
        nullable=True,
...
class DryOutDailyReportSchema(UrdhvaPostgresBase):
    ...
    dry_out_date: Mapped[typing.Optional[str]] = mapped_column(
        "dry_out_date",
        String,
        index=False,
        nullable=True,
    ...
    dry_out_count: Mapped[typing.Optional[str]] = mapped_column(
        "dry_out_count",
        String,
        index=False,
        nullable=True,
    ...
    dry_out_zone: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "dry_out_zone",
        JSONB,
        index=False,
        nullable=True,
    ...
    dry_out_alert_ids: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "dry_out_alert_ids",
        ARRAY(String),
        index=False,
        nullable=True,
...
class RoInterlockDisableSchema(UrdhvaPostgresBase):
    ...
    interlock_name: Mapped[str] = mapped_column(
        "interlock_name",
        String,
        index=False,
        nullable=False,
    ...
    is_sales_officer_approved: Mapped[typing.Optional[bool]] = mapped_column(
        "is_sales_officer_approved",
        Boolean,
        index=False,
        nullable=True,
        default=False,
    ...
    is_regional_manager_approved: Mapped[typing.Optional[bool]] = mapped_column(
        "is_regional_manager_approved",
        Boolean,
        index=False,
        nullable=True,
        default=False,
    ...
    is_zonal_head_approved: Mapped[typing.Optional[bool]] = mapped_column(
        "is_zonal_head_approved",
        Boolean,
        index=False,
        nullable=True,
        default=False,
...
class RoInterlockDisableCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    interlock_name: str
    bu: str
    is_sales_officer_approved: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_regional_manager_approved: typing.Optional[bool] = pydantic.Field(
        False,
    )
    is_zonal_head_approved: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class EMLockStatusSchema(UrdhvaPostgresBase):
    ...
    emlock_exception_id: Mapped[typing.Optional[str]] = mapped_column(
        "emlock_exception_id",
        String,
        index=False,
        nullable=True,
    ...
    terminal_code: Mapped[typing.Optional[str]] = mapped_column(
        "terminal_code",
        String,
        index=False,
        nullable=True,
    ...
    swipein_l1: Mapped[typing.Optional[bool]] = mapped_column(
        "swipein_l1",
        Boolean,
        index=False,
        nullable=True,
    ...
    swipein_l2: Mapped[typing.Optional[bool]] = mapped_column(
        "swipein_l2",
        Boolean,
        index=False,
        nullable=True,
    ...
    swipeout_l1: Mapped[typing.Optional[bool]] = mapped_column(
        "swipeout_l1",
        Boolean,
        index=False,
        nullable=True,
    ...
    swipeout_l2: Mapped[typing.Optional[bool]] = mapped_column(
        "swipeout_l2",
        Boolean,
        index=False,
        nullable=True,
    ...
    l1_id: Mapped[typing.Optional[str]] = mapped_column(
        "l1_id",
        String,
        index=False,
        nullable=True,
    ...
    l2_id: Mapped[typing.Optional[str]] = mapped_column(
        "l2_id",
        String,
        index=False,
        nullable=True,
...
class NotificationAuditLogSchema(UrdhvaPostgresBase):
    ...
    officers_username: Mapped[typing.Optional[str]] = mapped_column(
        "officers_username",
        String,
        index=False,
        nullable=True,
    ...
    notification_type: Mapped[typing.Optional[str]] = mapped_column(
        "notification_type",
        String,
        index=False,
        nullable=True,
    ...
    template_path: Mapped[typing.Optional[str]] = mapped_column(
        "template_path",
        String,
        index=False,
        nullable=True,
    ...
    transporter_details: Mapped[typing.Optional[typing.List[typing.Any]]] = (
        mapped_column(
            "transporter_details",
            JSONB,
            index=False,
...
class NotificationAuditLogCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    alert_id: typing.Optional[str] = pydantic.Field("", **{})
    transporter_details: (
        typing.Optional[typing.List[TransporterDetailsCreate]] | None
    ) = None
...
class EmailMasterSchema(UrdhvaPostgresBase):
    ...
    user: Mapped[typing.Optional[str]] = mapped_column(
        "user",
        String,
        index=False,
        nullable=True,
    ...
    section: Mapped[typing.Optional[str]] = mapped_column(
        "section",
        String,
        index=False,
        nullable=True,
    ...
    transporter_address: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_address",
        String,
        index=False,
        nullable=True,
    ...
    transporter_email1: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_email1",
        String,
        index=False,
        nullable=True,
    ...
    transporter_email2: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_email2",
        String,
        index=False,
        nullable=True,
    ...
    location_officer: Mapped[typing.Optional[str]] = mapped_column(
        "location_officer",
        String,
        index=False,
        nullable=True,
    ...
    zonal_transport_officer: Mapped[typing.Optional[str]] = mapped_column(
    ...
    zonal_head: Mapped[typing.Optional[str]] = mapped_column(
        "zonal_head",
        String,
        index=False,
        nullable=True,
    ...
    hqo1: Mapped[typing.Optional[str]] = mapped_column(
        "hqo1",
        String,
        index=False,
        nullable=True,
    ...
    hqo2: Mapped[typing.Optional[str]] = mapped_column(
        "hqo2",
        String,
        index=False,
        nullable=True,
    ...
    hqo3: Mapped[typing.Optional[str]] = mapped_column(
        "hqo3",
        String,
        index=False,
        nullable=True,
    ...
    hqo4: Mapped[typing.Optional[str]] = mapped_column(
        "hqo4",
        String,
        index=False,
        nullable=True,
    ...
    others: Mapped[typing.Optional[str]] = mapped_column(
        "others",
        String,
        index=False,
        nullable=True,
    ...
    driver_name: Mapped[typing.Optional[str]] = mapped_column(
        "driver_name",
        String,
        index=False,
        nullable=True,
    ...
    driver_number: Mapped[typing.Optional[str]] = mapped_column(
        "driver_number",
        String,
        index=False,
        nullable=True,
...
class SalesTripsTillDateSchema(UrdhvaPostgresBase):
    ...
    sbu_cd: Mapped[typing.Optional[str]] = mapped_column(
        "sbu_cd",
        String,
        index=False,
        nullable=True,
    ...
    sbu_nm: Mapped[typing.Optional[str]] = mapped_column(
        "sbu_nm",
        String,
        index=False,
        nullable=True,
    ...
    plant_cd: Mapped[typing.Optional[str]] = mapped_column(
        "plant_cd",
        String,
        index=False,
        nullable=True,
    ...
    plant_nm: Mapped[typing.Optional[str]] = mapped_column(
        "plant_nm",
        String,
        index=False,
        nullable=True,
    ...
    zone_cd: Mapped[typing.Optional[str]] = mapped_column(
        "zone_cd",
        String,
        index=False,
        nullable=True,
    ...
    zone_nm: Mapped[typing.Optional[str]] = mapped_column(
        "zone_nm",
        String,
        index=False,
        nullable=True,
    ...
    state_cd: Mapped[typing.Optional[str]] = mapped_column(
        "state_cd",
        String,
        index=False,
        nullable=True,
    ...
    state_nm: Mapped[typing.Optional[str]] = mapped_column(
        "state_nm",
        String,
        index=False,
        nullable=True,
    ...
    division: Mapped[typing.Optional[str]] = mapped_column(
        "division",
        String,
        index=False,
        nullable=True,
    ...
    material_group_cd: Mapped[typing.Optional[str]] = mapped_column(
        "material_group_cd",
        String,
        index=False,
        nullable=True,
    ...
    material_group_nm: Mapped[typing.Optional[str]] = mapped_column(
        "material_group_nm",
        String,
        index=False,
        nullable=True,
    ...
    item_no: Mapped[typing.Optional[str]] = mapped_column(
        "item_no",
        String,
        index=False,
        nullable=True,
    ...
    item_nm: Mapped[typing.Optional[str]] = mapped_column(
        "item_nm",
        String,
        index=False,
        nullable=True,
    ...
    customer: Mapped[typing.Optional[str]] = mapped_column(
        "customer",
        String,
        index=False,
        nullable=True,
    ...
    cust_nm: Mapped[typing.Optional[str]] = mapped_column(
        "cust_nm",
        String,
        index=False,
        nullable=True,
    ...
    invoice_no: Mapped[typing.Optional[str]] = mapped_column(
        "invoice_no",
        String,
        index=False,
        nullable=True,
    ...
    invoice_type: Mapped[typing.Optional[str]] = mapped_column(
        "invoice_type",
        String,
        index=False,
        nullable=True,
    ...
    invoice_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "invoice_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    load_status: Mapped[typing.Optional[str]] = mapped_column(
        "load_status",
        String,
        index=False,
        nullable=True,
    ...
    qty_shortage: Mapped[typing.Optional[float]] = mapped_column(
        "qty_shortage",
        Numeric,
        index=False,
        nullable=True,
    ...
    route: Mapped[typing.Optional[str]] = mapped_column(
        "route",
        String,
        index=False,
        nullable=True,
    ...
    load_no: Mapped[typing.Optional[str]] = mapped_column(
        "load_no",
        String,
        index=False,
        nullable=True,
    ...
    vehicle_id: Mapped[typing.Optional[str]] = mapped_column(
        "vehicle_id",
        String,
        index=False,
        nullable=True,
    ...
    carrier_no: Mapped[typing.Optional[str]] = mapped_column(
        "carrier_no",
        String,
        index=False,
        nullable=True,
    ...
    date_shipped: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "date_shipped",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    load_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "load_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    load_dt: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "load_dt",
        DateTime(timezone=True),
        index=False,
        nullable=True,
...
class VtsOngoingTripsSchema(UrdhvaPostgresBase):
    ...
    event_start_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
    ...
    event_end_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "event_end_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    tt_number: Mapped[typing.Optional[str]] = mapped_column(
        "tt_number",
        String,
        index=False,
        nullable=True,
    ...
    trip_id: Mapped[typing.Optional[str]] = mapped_column(
        "trip_id",
        String,
        index=False,
        nullable=True,
    ...
    transporter_id: Mapped[typing.Optional[str]] = mapped_column(
        "transporter_id",
        String,
        index=False,
        nullable=True,
    ...
    route_no: Mapped[typing.Optional[str]] = mapped_column(
        "route_no",
        String,
        index=False,
        nullable=True,
    ...
    scheduled_start_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    scheduled_end_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
    ...
    actual_trip_start_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    actual_end_start_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
            "actual_end_start_datetime",
            DateTime(timezone=True),
            index=False,
            nullable=True,
            default=None,
    ...
    vehicle_latitude: Mapped[typing.Optional[float]] = mapped_column(
        "vehicle_latitude",
        Numeric,
        index=False,
        nullable=True,
    ...
    vehicle_longitude: Mapped[typing.Optional[float]] = mapped_column(
        "vehicle_longitude",
        Numeric,
        index=False,
        nullable=True,
    ...
    vehicle_location: Mapped[typing.Optional[str]] = mapped_column(
        "vehicle_location",
        String,
        index=False,
        nullable=True,
    ...
    trip_completed_time: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "trip_completed_time",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    trip_status: Mapped[typing.Optional[str]] = mapped_column(
        "trip_status",
        String,
        index=False,
        nullable=True,
    ...
    vts_status: Mapped[typing.Optional[str]] = mapped_column(
        "vts_status",
        String,
        index=False,
        nullable=True,
    ...
    ims_status: Mapped[typing.Optional[str]] = mapped_column(
        "ims_status",
        String,
        index=False,
        nullable=True,
    ...
    destination_name: Mapped[typing.Optional[str]] = mapped_column(
        "destination_name",
        String,
        index=False,
        nullable=True,
...
class ViolationHistoryVtsSchema(UrdhvaPostgresBase):
    ...
    violation_name: Mapped[typing.Optional[str]] = mapped_column(
        "violation_name",
        String,
        index=False,
        nullable=True,
    ...
    violation_count: Mapped[typing.Optional[int]] = mapped_column(
        "violation_count",
        Integer,
        index=False,
        nullable=True,
    ...
    alert_status: Mapped[typing.Optional[typing.Any]] = mapped_column(
        "alert_status",
        String,
        index=False,
        nullable=True,
    ...
    approved_status: Mapped[typing.Optional[bool]] = mapped_column(
        "approved_status",
        Boolean,
        index=False,
        nullable=True,
    ...
    alert_state_timing: Mapped[typing.Optional[typing.List[typing.Any]]] = (
        mapped_column(
            "alert_state_timing",
            JSONB,
            index=False,
...
class ViolationHistoryVtsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    alert_status: typing.Optional[hpcl_ceg_enum.AlertStatus] | None = None
    approved_status: typing.Optional[bool] = pydantic.Field(
        False,
    )
    alert_id: typing.Optional[str] = pydantic.Field("", **{})
    invoice_number: typing.Optional[str] = pydantic.Field("", **{})
    ...
    sales_area: typing.Optional[str] = pydantic.Field("", **{})
    alert_history: typing.Optional[typing.List[Alert_HistoryCreate]] | None = None
    alert_state_timing: typing.Optional[typing.List[AlertStateTimingCreate]] | None = (
        None
    )
    last_sms_to: typing.Optional[typing.List[str]] = pydantic.Field("", **{})
    last_mailed_to: typing.Optional[typing.List[str]] = pydantic.Field("", **{})
...
class LpgDataPostingAuditSchema(UrdhvaPostgresBase):
    ...
    request_id: Mapped[typing.Optional[str]] = mapped_column(
        "request_id",
        String,
        index=False,
        nullable=True,
    ...
    remark: Mapped[typing.Optional[str]] = mapped_column(
        "remark",
        String,
        index=False,
        nullable=True,
    ...
    updated_date: Mapped[typing.Optional[str]] = mapped_column(
        "updated_date",
        String,
        index=False,
        nullable=True,
    ...
    updated_time: Mapped[typing.Optional[str]] = mapped_column(
        "updated_time",
        String,
        index=False,
        nullable=True,
...
class NoticesVTSSchema(UrdhvaPostgresBase):
    ...
    notices: Mapped[typing.Optional[typing.List[typing.Any]]] = mapped_column(
        "notices",
        JSONB,
        index=False,
        nullable=True,
...
class DeviceInstallationSchema(UrdhvaPostgresBase):
    ...
    sap_tt_no: Mapped[typing.Optional[str]] = mapped_column(
        "sap_tt_no",
        String,
        index=True,
        nullable=True,
    ...
    tt_chassis_no: Mapped[typing.Optional[str]] = mapped_column(
        "tt_chassis_no",
        String,
        index=False,
        nullable=True,
    ...
    tt_engine_no: Mapped[typing.Optional[str]] = mapped_column(
        "tt_engine_no",
        String,
        index=False,
        nullable=True,
    ...
    select_business: Mapped[typing.Optional[str]] = mapped_column(
        "select_business",
        String,
        index=False,
        nullable=True,
    ...
    location: Mapped[typing.Optional[str]] = mapped_column(
        "location",
        String,
        index=True,
        nullable=True,
    ...
    transporter: Mapped[typing.Optional[str]] = mapped_column(
        "transporter",
        String,
        index=False,
        nullable=True,
    ...
    device: Mapped[typing.Optional[str]] = mapped_column(
        "device",
        String,
        index=False,
        nullable=True,
    ...
    vehicle_installed_by: Mapped[typing.Optional[str]] = mapped_column(
        "vehicle_installed_by",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    vehicle_installation_date: Mapped[typing.Optional[str]] = mapped_column(
    ...
    device_installation_approved_by: Mapped[typing.Optional[str]] = mapped_column(
        "device_installation_approved_by",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    contract_valid_upto: Mapped[typing.Optional[str]] = mapped_column(
        "contract_valid_upto",
        String,
        index=False,
        nullable=True,
    ...
    certificate: Mapped[typing.Optional[str]] = mapped_column(
        "certificate",
        String,
        index=False,
        nullable=True,
    ...
    reason_for_cancel: Mapped[typing.Optional[str]] = mapped_column(
        "reason_for_cancel",
        String,
        index=False,
        nullable=True,
    ...
    status_decommissioning: Mapped[typing.Optional[str]] = mapped_column(
    ...
    commissioning_status: Mapped[typing.Optional[str]] = mapped_column(
    ...
    commissioning_status_code: Mapped[typing.Optional[str]] = mapped_column(
        "commissioning_status_code",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    commissioning_responses: Mapped[typing.Optional[str]] = mapped_column(
        "commissioning_responses",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    commissioned_at: Mapped[typing.Optional[str]] = mapped_column(
        "commissioned_at",
        String,
        index=False,
        nullable=True,
    ...
    commissioning_responses_2: Mapped[typing.Optional[str]] = mapped_column(
        "commissioning_responses_2",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    de_commissioning_responses: Mapped[typing.Optional[str]] = mapped_column(
        "de_commissioning_responses",
        String,
        index=False,
        nullable=True,
        default="",
    ...
    aot_status: Mapped[typing.Optional[str]] = mapped_column(
        "aot_status",
        String,
        index=True,
        nullable=True,
    ...
    aot_sap_tt_no: Mapped[typing.Optional[str]] = mapped_column(
        "aot_sap_tt_no",
        String,
        index=False,
        nullable=True,
    ...
    aot_request_type: Mapped[typing.Optional[str]] = mapped_column(
        "aot_request_type",
        String,
        index=False,
        nullable=True,
    ...
    expiry_alert_created: Mapped[typing.Optional[bool]] = mapped_column(
    ...
    tibco_expiry_date: Mapped[typing.Optional[str]] = mapped_column(
        "tibco_expiry_date",
        String,
        index=True,
        nullable=True,
    ...
    zone_code: Mapped[typing.Optional[str]] = mapped_column(
        "zone_code",
        String,
        index=False,
        nullable=True,
...
class DeviceInstallationCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    expiry_alert_created: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class CreateUserCreate(pydantic.BaseModel):
    ...
    bu: typing.Optional[typing.List[str]] = pydantic.Field("", **{})
    contact_number: typing.Optional[str] = pydantic.Field("", **{})
    is_ad_user: typing.Optional[bool] = pydantic.Field(
        False,
    )
    status: typing.Optional[bool] = pydantic.Field(
        False,
    )
    lock_for_auto_sync: typing.Optional[bool] = pydantic.Field(
        False,
    )
    file_path: typing.Optional[str] = pydantic.Field("", **{})
...
class SystemAuditLogSchema(UrdhvaPostgresBase):
    ...
    role: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "role",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    action: Mapped[typing.Optional[str]] = mapped_column(
        "action",
        String,
        index=False,
        nullable=True,
    ...
    action_model: Mapped[typing.Optional[str]] = mapped_column(
        "action_model",
        String,
        index=False,
        nullable=True,
...
class CrisDryOutSyncSchema(UrdhvaPostgresBase):
    ...
    total_dryouts: Mapped[int] = mapped_column(
        "total_dryouts",
        Integer,
        index=False,
        nullable=False,
    ...
    ms_hsd_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "ms_hsd_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    ms_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "ms_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    hsd_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "hsd_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    turbo_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "turbo_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    e20_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "e20_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    power95_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "power95_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    power99_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "power99_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    power100_dryouts: Mapped[typing.Optional[int]] = mapped_column(
        "power100_dryouts",
        Integer,
        index=False,
        nullable=True,
    ...
    dry_out_in_days: Mapped[str] = mapped_column(
        "dry_out_in_days",
        String,
        index=False,
        nullable=False,
...
class HyperLocalSchema(UrdhvaPostgresBase):
    ...
    report_date: Mapped[datetime.date] = mapped_column(
        "report_date",
        DATE,
        index=True,
        nullable=False,
    ...
    neutral_reviews: Mapped[int] = mapped_column(
        "neutral_reviews",
        Integer,
        index=False,
        nullable=False,
    ...
    zone_summary: Mapped[typing.List[typing.Any]] = mapped_column(
        "zone_summary",
        JSONB,
        index=False,
        nullable=False,
    ...
    sentiment_of_reviews: Mapped[typing.List[typing.Any]] = mapped_column(
...
class HyperLocal(urdhva_base.postgresmodel.PostgresModel):
    ...
    zone_summary: typing.Optional[typing.List[HyperLocalZoneSummaryCreate]] | None = (
        None
    )
    sentiment_of_reviews: (
        typing.Optional[typing.List[ReviewsSentimentCreate]] | None
    ) = None
...
class NozzleSalesSchema(UrdhvaPostgresBase):
    ...
    product_grp: Mapped[str] = mapped_column(
        "product_grp",
        String,
        index=True,
        nullable=False,
    ...
    sales_volume: Mapped[float] = mapped_column(
        "sales_volume",
        Numeric,
        index=True,
        nullable=False,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            product_grp,
            sales_volume,
            name="nozzle_sales_transaction_date_sap_id_product_grp_sales_volume",
        ),
    )
...
class TasFaultySchema(UrdhvaPostgresBase):
    ...
    selecting_areas: Mapped[str] = mapped_column(
        "selecting_areas",
        String,
        index=False,
        nullable=False,
    ...
    faulty_history: Mapped[typing.List[typing.Any]] = mapped_column(
        "faulty_history",
        JSONB,
        index=False,
        nullable=False,
    ...
    user_remarks: Mapped[typing.Optional[str]] = mapped_column(
        "user_remarks",
        String,
        index=False,
        nullable=True,
    ...
    tas_faulty_unique_id: Mapped[str] = mapped_column(
    ...
    vendor_remarks: Mapped[typing.Optional[str]] = mapped_column(
        "vendor_remarks",
        String,
        index=False,
        nullable=True,
    ...
    faulty_date: Mapped[datetime.datetime] = mapped_column(
        "faulty_date",
        DateTime(timezone=True),
        index=False,
        nullable=False,
    ...
    __table_args__ = (
        UniqueConstraint(tas_faulty_unique_id, name="tas_faulty_tas_faulty_unique_id"),
    )
...
class TasSealDateFormSchema(UrdhvaPostgresBase):
    ...
    actual_w_and_m_seal_date: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
    ...
    next_due_date: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "next_due_date",
        DateTime(timezone=True),
        index=False,
        nullable=True,
    ...
    certificate: Mapped[typing.List[str]] = mapped_column(
        "certificate",
        ARRAY(String),
        index=False,
        nullable=False,
    ...
    present_k_factor: Mapped[typing.Optional[str]] = mapped_column(
        "present_k_factor",
        String,
        index=False,
        nullable=True,
    ...
    past_k_factor: Mapped[typing.Optional[str]] = mapped_column(
        "past_k_factor",
        String,
        index=False,
        nullable=True,
...
class TasFireEngineTestSchema(UrdhvaPostgresBase):
    ...
    fire_engine_on_datetime: Mapped[typing.Optional[datetime.datetime]] = mapped_column(
        "fire_engine_on_datetime",
        DateTime(timezone=True),
        index=False,
        nullable=True,
        default=None,
    ...
    fire_engine_off_datetime: Mapped[typing.Optional[datetime.datetime]] = (
        mapped_column(
            "fire_engine_off_datetime",
            DateTime(timezone=True),
            index=False,
            nullable=True,
            default=None,
    ...
    total_run_time: Mapped[typing.Optional[str]] = mapped_column(
        "total_run_time",
        String,
        index=False,
        nullable=True,
...
class TerminalWiseDryoutCountsSchema(UrdhvaPostgresBase):
    ...
    terminal_id: Mapped[typing.Optional[str]] = mapped_column(
        "terminal_id",
        String,
        index=True,
        nullable=True,
    ...
    terminal_name: Mapped[typing.Optional[str]] = mapped_column(
        "terminal_name",
        String,
        index=False,
        nullable=True,
    ...
    outlets: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "outlets",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    dryout_ros: Mapped[typing.Optional[int]] = mapped_column(
        "dryout_ros",
        Integer,
        index=False,
        nullable=True,
    ...
    outlets_with_valid_indents: Mapped[typing.Optional[int]] = mapped_column(
        "outlets_with_valid_indents",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    valid_pending_indents_last_3days: Mapped[typing.Optional[int]] = mapped_column(
        "valid_pending_indents_last_3days",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    pending_indents_last_3days: Mapped[typing.Optional[int]] = mapped_column(
        "pending_indents_last_3days",
        Integer,
        index=False,
        nullable=True,
        default=0,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            terminal_id,
            region,
            name="terminal_wise_dryout_counts_run_id_zone_terminal_id_region",
        ),
    )
...
class NonReportingDevicesSchema(UrdhvaPostgresBase):
    ...
    last_check_date: Mapped[datetime.date] = mapped_column(
        "last_check_date",
        DATE,
        index=False,
        nullable=False,
    ...
    device_working: Mapped[str] = mapped_column(
        "device_working",
        String,
        index=False,
        nullable=False,
    ...
    completed_trip: Mapped[str] = mapped_column(
        "completed_trip",
        String,
        index=False,
        nullable=False,
    ...
    completed_trip_auto_dc: Mapped[str] = mapped_column(
    ...
    card_date: Mapped[datetime.datetime] = mapped_column(
        "card_date",
        DateTime(timezone=False),
        index=False,
        nullable=False,
    ...
    card_time: Mapped[str] = mapped_column(
        "card_time",
        String,
        index=False,
        nullable=False,
    ...
    card_datetime: Mapped[datetime.datetime] = mapped_column(
        "card_datetime",
        DateTime(timezone=False),
        index=False,
        nullable=False,
    ...
    loaded_on: Mapped[datetime.datetime] = mapped_column(
        "loaded_on",
        DateTime(timezone=False),
        index=False,
        nullable=False,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            last_check_time,
            location,
            name="non_reporting_devices_truck_lastc_lastc_locat",
        ),
    )
...
class TasHelpDeskVendorMailsSchema(UrdhvaPostgresBase):
    ...
    level1: Mapped[str] = mapped_column(
        "level1",
        String,
        index=False,
        nullable=False,
    ...
    level2: Mapped[str] = mapped_column(
        "level2",
        String,
        index=False,
        nullable=False,
    ...
    level3: Mapped[str] = mapped_column(
        "level3",
        String,
        index=False,
        nullable=False,
...
class NaturalGasGVConnectionsSchema(UrdhvaPostgresBase):
    ...
    gv_name: Mapped[str] = mapped_column(
        "gv_name",
        String,
        index=True,
        nullable=False,
    ...
    conn_date: Mapped[datetime.date] = mapped_column(
        "conn_date",
        DATE,
        index=True,
        nullable=False,
    ...
    ga_name: Mapped[str] = mapped_column(
        "ga_name",
        String,
        index=True,
        nullable=False,
    ...
    achieved_count: Mapped[int] = mapped_column(
        "achieved_count",
        Integer,
        index=False,
        nullable=False,
    ...
    day_wise_target: Mapped[typing.Optional[int]] = mapped_column(
        "day_wise_target",
        Integer,
        index=False,
        nullable=True,
    ...
    backlog_lmc: Mapped[typing.Optional[int]] = mapped_column(
        "backlog_lmc",
        Integer,
        index=False,
        nullable=True,
    ...
    backlog_ngc: Mapped[typing.Optional[int]] = mapped_column(
        "backlog_ngc",
        Integer,
        index=False,
        nullable=True,
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            conn_date,
            ga_name,
            name="natural_gas_gv_connections_gv_name_conn_date_ga_name",
        ),
    )
...
class TankDiaDetailsSchema(UrdhvaPostgresBase):
    ...
    location_sap_code: Mapped[str] = mapped_column(
        "location_sap_code",
        String,
        index=False,
        nullable=False,
    ...
    gross_capacity_kl: Mapped[float] = mapped_column(
        "gross_capacity_kl",
        Numeric,
        index=False,
        nullable=False,
    ...
    peso_capacity_kl: Mapped[float] = mapped_column(
        "peso_capacity_kl",
        Numeric,
        index=False,
        nullable=False,
    ...
    pumpable_volume_kl: Mapped[float] = mapped_column(
        "pumpable_volume_kl",
        Numeric,
        index=False,
        nullable=False,
    ...
    dead_stock_kl: Mapped[float] = mapped_column(
        "dead_stock_kl",
        Numeric,
        index=False,
        nullable=False,
    ...
    location_specific_limitations: Mapped[str] = mapped_column(
        "location_specific_limitations",
        String,
        index=False,
        nullable=False,
        default=None,
    ...
    kl_per_mm: Mapped[float] = mapped_column(
        "kl_per_mm",
        Numeric,
        index=False,
        nullable=False,
...
class DailyEmailNotificationUsersSchema(UrdhvaPostgresBase):
    ...
    subject: Mapped[typing.Optional[str]] = mapped_column(
        "subject",
        String,
        index=False,
        nullable=True,
    ...
    enabled: Mapped[typing.Optional[bool]] = mapped_column(
        "enabled",
        Boolean,
        index=False,
        nullable=True,
    ...
    audience: Mapped[typing.Optional[str]] = mapped_column(
        "audience",
        String,
        index=False,
        nullable=True,
    ...
    to_recipients: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "to_recipients",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    cc_recipients: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "cc_recipients",
        ARRAY(String),
        index=False,
        nullable=True,
    ...
    bcc_recipients: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "bcc_recipients",
        ARRAY(String),
        index=False,
        nullable=True,
...
class LpgCarousalsSchema(UrdhvaPostgresBase):
    ...
    sap_id: Mapped[int] = mapped_column(
        "sap_id",
        Integer,
        index=False,
        nullable=False,
    ...
    carousal_id: Mapped[int] = mapped_column(
        "carousal_id",
        Integer,
        index=False,
        nullable=False,
    ...
    heads: Mapped[int] = mapped_column(
        "heads",
        Integer,
        index=False,
        nullable=False,
    ...
    rated_productivity: Mapped[int] = mapped_column(
        "rated_productivity",
        Integer,
        index=False,
        nullable=False,
    ...
    production_hrs: Mapped[typing.List[typing.Any]] = mapped_column(
        "production_hrs",
        JSONB,
        index=False,
        nullable=False,
    ...
    breaks: Mapped[typing.List[typing.Any]] = mapped_column(
        "breaks",
        JSONB,
        index=False,
        nullable=False,
    ...
    min_productivity: Mapped[typing.Optional[int]] = mapped_column(
        "min_productivity",
        Integer,
        index=False,
        nullable=True,
    ...
    max_productivity: Mapped[typing.Optional[int]] = mapped_column(
        "max_productivity",
        Integer,
        index=False,
        nullable=True,
    ...
    skip_zero_performance_score: Mapped[typing.Optional[bool]] = mapped_column(
        "skip_zero_performance_score",
        Boolean,
        index=False,
        nullable=True,
        default=False,
...
class LpgCarousalsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    skip_zero_performance_score: typing.Optional[bool] = pydantic.Field(
        False,
    )
...
class LpgPlantsMasterSchema(UrdhvaPostgresBase):
    ...
    password: Mapped[urdhva_base.types.Secret] = mapped_column(
        "password",
        String,
        index=False,
        nullable=False,
    ...
    plant_name: Mapped[typing.Optional[str]] = mapped_column(
        "plant_name",
        String,
        index=False,
        nullable=True,
    ...
    mail_recipients: Mapped[typing.Optional[typing.List[str]]] = mapped_column(
        "mail_recipients",
        ARRAY(String),
        index=False,
        nullable=True,
