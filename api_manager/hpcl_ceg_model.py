...
class VtsTruckDetailsSchema(UrdhvaPostgresBase):
    ...
    truck_history: Mapped[typing.Optional[typing.Any]] = mapped_column("truck_history", JSONB, index=False, nullable=True, default=None, primary_key=False, unique=False)
...
class VtsTruckDetailsCreate(urdhva_base.postgresmodel.BasePostgresModel):
    ...
    truck_history: typing.Optional[VtsTruckHistoryCreate] | None = None
