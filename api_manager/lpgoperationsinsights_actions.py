...
async def lpgoperationsinsights_lpg_plants_insights(
    data: Lpgoperationsinsights_Lpg_Plants_InsightsParams,
):
...
async def lpgoperationsinsights_lpg_car_download(
    data: Lpgoperationsinsights_Lpg_Car_DownloadParams,
):
