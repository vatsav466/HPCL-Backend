...
async def industryperformance_generate_ai_industry_performance(
    data: Industryperformance_Generate_Ai_Industry_PerformanceParams,
):
...
async def industryperformance_list_ai_industry_performance_queries(
    data: Industryperformance_List_Ai_Industry_Performance_QueriesParams,
):
    return await industry_generative_ai.list_ai_industry_performance_queries(
        data.search_text
    )
