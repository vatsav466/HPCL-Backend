...
async def cegrolemaster_get_ceg_role_master(
    data: Cegrolemaster_Get_Ceg_Role_MasterParams,
):
    """
...
async def cegrolemaster_download_ceg_role_master(
    data: Cegrolemaster_Download_Ceg_Role_MasterParams,
):
    """
...
async def cegrolemaster_upload_dnc_role_master(
