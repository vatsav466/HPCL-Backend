interlock_to_category = {
    ...
    "Gantry": [
        ...
        "BCU Local Loading" "BCU Totalizer Mismatch with MFM Totalizer",
        "K - Factor Changed",
    ...
    "Check Scale alerts": ["Check Scale Rejection"],
    "Valve leak alerts": ["Valve Leakage Rejection"],
    "Valve leak alerts": ["O-Ring Leakage Rejection"],
}
