...
tas_interlock_mapping = [
                         ...
                         {"sop_id": "SOP001", "interlock_name": "Tank Overfill Protection", "workflow_name": ""},
                         {"sop_id": "SOP01A", "interlock_name": "Tank overfill prevention close inlet MOV", "workflow_name": "Tank Overfill Protection"},
                         ...
                         {"sop_id": "SOP02A", "interlock_name": "All ROSOVs closed", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "Tanks in TTL Dispatch in Dormant Mode", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "As Power ESD Activation in Main PMCC Panel after 120 Sec", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "Hooter cum strobe for ESD activated in control room", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "Siren Activated", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "ESD Command To Process PLC", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "All DBBVs Closed", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "All Tanks in Dormant Mode", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "All TLF Product Pumps Stopped ", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "TLF Gantry Permissive Power Off", "workflow_name": ""},
                         {"sop_id": "SOP02A", "interlock_name": "Barrier Gate opened", "workflow_name": ""},
                         {"sop_id": "SOP003", "interlock_name": "Tank Overfill Proof test Updated", "workflow_name": ""},
                         {"sop_id": "SOP003", "interlock_name": "Tank Overfill Proof test Failed", "workflow_name": ""},
                         {"sop_id": "SOP005", "interlock_name": "HCDS Audio Alarm in Control Room, Audio Alarm in Field", "workflow_name": "TAS HCD AND DYKE ACTIVATION"},
                         {"sop_id": "SOP006", "interlock_name": "Earthing Failure Alarm", "workflow_name": ""},
                         ...
                         {"sop_id": "SOP024", "interlock_name": "BCU Totalizer Mismatch with last day Totalizer", "workflow_name": ""},
                         ...
                         {"sop_id": "SOP028", "interlock_name": "Person not wearing safety helmet", "model": "VA", "workflow_name": "UC_TAS_SOP27_33"},
                         {"sop_id": "SOP028", "interlock_name": "Pulse Security", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "K-Factors", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "No Flow", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Low Flow", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "High Flow Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Unauthorized Flow Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Meter overrun Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Blend overdose Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Blend Underdose Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Additive Overdose Alarm", "workflow_name": ""},
                         {"sop_id": "SOP028", "interlock_name": "Additive Underdose Alarm", "workflow_name": ""},
                         ...
                         {"sop_id": "SOP032", "interlock_name": "Primary RG High Level alarm", "workflow_name": ""},
...
ro_interlock_mapping = [{"sop_id": "SOP001", "interlock_name": "VTS RouteDeviation FirstTime", "model": "VTS", "workflow_name": "Ro_Vts_Deviation_FirstTime_90days"},
                        ...
                        {"sop_id": "SOP015", "interlock_name": "Person not wearing safety helmet", "model": "VA", "workflow_name": "UC_RO_SOP14_20"},
...
lpg_interlock_mapping = [
    ...
    {"sop_id": "SOP022", "interlock_name": "Person not wearing safety helmet", "model": "VA", "workflow_name": "UC_LPG_SOP21_27"},
