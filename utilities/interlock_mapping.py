...
tas_interlock_mapping = [
                         ...
                         {"sop_id": "SOP007", "interlock_name": "Tank overfill prevention close inlet MOV", "workflow_name": ""},
...
ro_interlock_mapping = [{"sop_id": "SOP001", "interlock_name": "Auto RSP Interlock"},
                        ...
                        {"sop_id": "SOP008", "interlock_name": "Absence Of Earthing","model": "VA"},
                        {"sop_id": "SOP008", "interlock_name": "Absence Of Wheelchock RO","model": "VA"},
                        {"sop_id": "SOP009", "interlock_name": "Alight From Two Wheeler", "model": "VA"},
                        {"sop_id": "SOP009", "interlock_name": "Unauthorised Filling Of Container", "model": "VA"},
                        ...
                        {"sop_id": "SOP016", "interlock_name": "Absence Of Fire Extinguisher Decantation", "model": "VA"},
                        {"sop_id": "SOP017", "interlock_name": "Smoke Detection RO", "model": "VA"},
                        {"sop_id": "SOP017", "interlock_name": "Fire Detection RO", "model": "VA"},
                        {"sop_id": "SOP017", "interlock_name": "Fire/Smoke Detection RO", "model": "VA"},
...
lpg_interlock_mapping = [
    ...
    {"sop_id": "SOP014", "interlock_name": "Intrusion Person At Perimeter", "model": "VA"},
    {"sop_id": "SOP014", "interlock_name": "Missing Wheel Chock", "model": "VA"},
    ...
    {"sop_id": "SOP017", "interlock_name": "Lpg Leakage Detection", "model": "VA"},
    {"sop_id": "SOP017", "interlock_name": "Lpg Leakage Filling Gun", "model": "VA"},
    {"sop_id": "SOP017", "interlock_name": "Smoke Detection LPG", "model": "VA"},
    {"sop_id": "SOP017", "interlock_name": "Fire/Smoke Detection LPG", "model": "VA"},
    {"sop_id": "SOP017", "interlock_name": "Fire Detection LPG", "model": "VA"},
    {"sop_id": "SOP021", "interlock_name": "Person not wearing Safety Helmet LPG", "model": "VA"},
    {"sop_id": "SOP022", "interlock_name": "Person not wearing Safety Harness/Belt LPG", "model": "VA"},
    {"sop_id": "SOP023", "interlock_name": "Fire Extinguisher", "model": "VA"},
