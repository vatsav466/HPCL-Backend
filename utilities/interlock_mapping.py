...
tas_interlock_mapping = [
                         ...
                         {"sop_id": "SOP024", "interlock_name": "Intrusion", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP024", "interlock_name": "Smoke Detection", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP024", "interlock_name": "Fire Detection", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP024", "interlock_name": "Fire/Smoke Detection", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP024", "interlock_name": "Absence Of Wheelchock", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP025", "interlock_name": "Non-wearing of Safety Belt at Height", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP026", "interlock_name": "Non-Wearing of Safety Helmet", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP027", "interlock_name": "Person not wearing Safety Helmet", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP028", "interlock_name": "Person not wearing Safety Harness/Belt", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP029", "interlock_name": "Absence Of Fire Extinguisher Tt Operations", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP030", "interlock_name": "Fire Hose is not available", "model": "VA", "workflow_name": "TasVaWorkflow"},
                         {"sop_id": "SOP031", "interlock_name": "Person not wearing Protective Clothing", "model": "VA", "workflow_name": "TasVaWorkflow"},
...
ro_interlock_mapping = [{"sop_id": "SOP001", "interlock_name": "Auto RSP Interlock"},
                        ...
                        {"sop_id": "SOP008", "interlock_name": "Absence Of Earthing","model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP008", "interlock_name": "Absence Of Wheelchock","model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP009", "interlock_name": "Alight From Two Wheeler", "model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP009", "interlock_name": "Unauthorised Filling Of Container", "model": "VA", "workflow_name": "RoVaWorkflow"},
                        ...
                        {"sop_id": "SOP016", "interlock_name": "Absence Of Fire Extinguisher Decantation", "model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP017", "interlock_name": "Smoke Detection", "model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP017", "interlock_name": "Fire Detection", "model": "VA", "workflow_name": "RoVaWorkflow"},
                        {"sop_id": "SOP017", "interlock_name": "Fire/Smoke Detection", "model": "VA", "workflow_name": "RoVaWorkflow"},
...
lpg_interlock_mapping = [
    ...
    {"sop_id": "SOP014", "interlock_name": "Intrusion Person At Perimeter", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP014", "interlock_name": "Missing Wheel Chock", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP015", "interlock_name": "Non-wearing of Helmet", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP016", "interlock_name": "Non-wearing of Safety Belt at Height", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP017", "interlock_name": "Lpg Leakage Detection", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP017", "interlock_name": "Lpg Leakage Filling Gun", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP017", "interlock_name": "Smoke Detection", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP017", "interlock_name": "Fire/Smoke Detection", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP017", "interlock_name": "Fire Detection", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP021", "interlock_name": "Person not wearing Safety Helmet", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP022", "interlock_name": "Person not wearing Safety Harness/Belt", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP023", "interlock_name": "Fire Extinguisher", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP024", "interlock_name": "Fire Hose is not available", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP025", "interlock_name": "Person not wearing Protective Clothing", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP026", "interlock_name": "Camera is offline", "model": "VA", "workflow_name": "LpgVaWorkflow"},
    {"sop_id": "SOP027", "interlock_name": "Work Beyond time", "model": "VA", "workflow_name": "LpgVaWorkflow"},
