...
tas_interlock_mapping = [
                        ...
                        {"sop_id": "SOP002", "interlock_name": "Plant ESD activated", "workflow_name": "TAS ESD CLOSURE OF EFFECT SOP002"},
                        {"sop_id": "SOP002", "interlock_name": "EM Locks : VTS Offline - Customer", "model": "VTS", "workflow_name": ""},
                        {"sop_id": "SOP02A", "interlock_name": "All ROSOVs closed(Except PL Receipt)", "workflow_name": "ESD FIRE EFFECTS"},
                        ...
                        {"sop_id": "SOP02A", "interlock_name": "All DBBVs Closed(Except PL Receipt)", "workflow_name": "ESD FIRE EFFECTS"},
                        ...
                        {"sop_id": "SOP02A", "interlock_name": "Gantry Permissive Off", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Barrier Gate opened", "workflow_name": "ESD FIRE EFFECTS"},

                        {"sop_id": "SOP02A", "interlock_name": "All ROSOVs closed(Except PL Receipt)_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Tanks in TTL Dispatch in Dormant Mode_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "As Power ESD Activation in Main PMCC Panel after 120 Sec_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Hooter cum strobe for ESD activated in control room_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Siren Activated_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "ESD Command To Process PLC_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "All DBBVs Closed(Except PL Receipt)_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "All Tanks in Dormant Mode_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "All TLF Product Pumps Stopped_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Gantry Permissive Off_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "Barrier Gate opened_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        {"sop_id": "SOP02A", "interlock_name": "ESD ROSOV_Close Status_Fail", "workflow_name": "ESD FIRE EFFECTS"},
                        ...
                        {"sop_id": "SOP023", "interlock_name": "Main Fire Engines not in REMOTE", "workflow_name": ""},
                        {"sop_id": "SOP023", "interlock_name": "WATER Level below Reference Volume", "workflow_name": ""},
                        {"sop_id": "SOP023", "interlock_name": "Two Fire Engine Running status", "workflow_name": ""},
